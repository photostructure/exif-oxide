...
impl Default for BinaryDataStrategy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl BinaryDataStrategy {
    ...
    fn generate_binary_data_code(
        ...
        code.push_str(&format!(
            "//! Generated binary data parsing definitions from {}::{}\n",
            extraction.module_name, extraction.table_name
        ));
        code.push_str("//!\n");
        code.push_str("//! This file is auto-generated by codegen/src/strategies/binary_data.rs. Do not edit manually.\n");
        code.push('\n');
        ...
        for entry in entries {
            ...
            code.push_str(&format!(
                "    entries.insert({offset}, BinaryDataEntry {{\n"
            ));
            code.push_str(&format!("        name: \"{name}\",\n"));
            code.push_str(&format!("        format: \"{format}\",\n"));
            code.push_str(&format!("        count: {count},\n"));
