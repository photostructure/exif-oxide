...
impl Default for BooleanSetStrategy {
    fn default() -> Self {
        Self::new()
    }
}
...
impl BooleanSetStrategy {
    ...
    fn generate_boolean_set_code(boolean_set: &BooleanSet) -> String {
        ...
        code.push_str(&format!(
            "//! Generated boolean set for {}\n",
            boolean_set.name
        ));
        code.push_str("//!\n");
        code.push_str("//! This file is auto-generated by codegen/src/strategies/boolean_set.rs. Do not edit manually.\n");
        code.push('\n');
        ...
        code.push_str(&format!(
            "pub static {const_name}: LazyLock<HashSet<&'static str>> = LazyLock::new(|| {{\n"
        ));
        code.push_str("    let mut set = HashSet::new();\n");

        for key in &boolean_set.keys {
            code.push_str(&format!("    set.insert(\"{key}\");\n"));
        }
        ...
        code.push_str(&format!("pub fn is_{fn_name}(key: &str) -> bool {{\n"));
        code.push_str(&format!("    {const_name}.contains(key)\n"));
        code.push_str("}\n");
