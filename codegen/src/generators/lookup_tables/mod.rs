...
fn generate_table_file(
    ...
    let module_path = if extracted_table.source.module.contains("/") {
        // Already a path
        extracted_table.source.module.clone()
    } else if extracted_table.source.module == "Image::ExifTool" {
        // Main module
        "third-party/exiftool/lib/Image/ExifTool.pm".to_string()
    } else if extracted_table.source.module.starts_with("Image::ExifTool::") {
        // Perl module format: Image::ExifTool::Canon -> third-party/exiftool/lib/Image/ExifTool/Canon.pm
        let module_name = extracted_table.source.module.strip_prefix("Image::ExifTool::").unwrap();
        ...
        let base_name = extracted_table.source.module.strip_suffix(".pm").unwrap_or(&extracted_table.source.module);
