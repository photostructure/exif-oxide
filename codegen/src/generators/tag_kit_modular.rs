...
pub fn generate_modular_tag_kit(
    ...
    for (category, tag_kits) in &categories {
        ...
        let file_path = format!("{}/{}.rs", tag_kit_dir, module_name_cat);
...
fn generate_mod_file(
    ...
    code.push_str(&format!("/// All tag kits for {}\n", module_name));
