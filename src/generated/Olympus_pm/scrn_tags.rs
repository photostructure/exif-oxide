//! Generated tag table definitions from Olympus::scrn
//!
...
/// Tag definitions for Olympus::scrn table
pub static OLYMPUS_SCRN_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            0,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = OLYMPUS_SCRN_TAGS.get(&tag_id_u16) {
