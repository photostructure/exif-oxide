...
static PRINT_CONV_53: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    let mut map = HashMap::new();
    map.insert("0".to_string(), "Off");
    map.insert("1".to_string(), "On, S-IS1 (All Direction Shake I.S.)");
    map.insert("2".to_string(), "On, S-IS2 (Vertical Shake I.S.)");
    map.insert("3".to_string(), "On, S-IS3 (Horizontal Shake I.S.)");
    map.insert("4".to_string(), "On, S-IS Auto (Auto I.S.)");
    map
});
...
static PRINT_CONV_60: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    let mut map = HashMap::new();
    map.insert("0".to_string(), "Off");
    map.insert("1024".to_string(), "Birds, Object Not Found");
    map.insert("1025".to_string(), "Birds Object Found");
    map.insert("1280".to_string(), "Dogs & Cats, Object Not Found");
    map.insert("1281".to_string(), "Dogs & Cats, Object Found");
    map.insert("1536".to_string(), "Human, Object Not Found");
    map.insert("1537".to_string(), "Human, Object Found");
    map.insert("256".to_string(), "Motorsports; Object Not Found");
    map.insert("257".to_string(), "Motorsports; Racing Car Found");
    map.insert("258".to_string(), "Motorsports; Car Found");
    map.insert("259".to_string(), "Motorsports; Motorcyle Found");
    map.insert("512".to_string(), "Airplanes; Object Not Found");
    map.insert(
        "513".to_string(),
        "Airplanes; Passenger/Transport Plane Found",
    );
    map.insert(
        "514".to_string(),
        "Airplanes; Small Plane/Fighter Jet Found",
    );
    map.insert("515".to_string(), "Airplanes; Helicopter Found");
    map.insert("768".to_string(), "Trains, Object Not Found");
    map.insert("769".to_string(), "Trains, Object Found");
    map
});
...
static PRINT_CONV_61: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    ...
    map.insert("2".to_string(), "Removed");
    map
});
...
static PRINT_CONV_70: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    let mut map = HashMap::new();
    map.insert("SG472".to_string(), "u7040,S7040");
    map.insert("SG473".to_string(), "u9010,S9010");
    map.insert("SG475".to_string(), "SP800UZ");
    map.insert("SG551".to_string(), "SZ-30MR");
    map.insert("SG553".to_string(), "SP-610UZ");
    map.insert("SG554".to_string(), "SZ-10");
    map.insert("SG555".to_string(), "SZ-20");
    map.insert("SG573".to_string(), "SZ-14");
    map.insert("SG575".to_string(), "SP-620UZ");
    map
});
...
pub fn get_other_tags() -> Vec<(u32, TagKitDef)> {
    vec![
        ...
        (1285, TagKitDef {
            ...
            print_conv: PrintConvType::Expression("my @v=split \" \",$val; \"$v[0] (min $v[1], max $v[2])\""),
            value_conv: None,
            subdirectory: None,
        }),
        (1286, TagKitDef {
        ...
        (2081, TagKitDef {
            ...
            groups: HashMap::new(),
            writable: true,
            notes: Some("2 numbers: 1. Default sensitivty, 2. Maximum sensitivity"),
            print_conv: PrintConvType::Manual("array_printconv"),
            value_conv: None,
            subdirectory: None,
        }),
        ...
        (0, TagKitDef {
            ...
            groups: HashMap::new(),
            writable: false,
            notes: Some("based on tags found in some Panasonic RW2 images"),
        ...
        (62, TagKitDef {
            ...
            value_conv: Some("$val =~ /(\\d{2})(\\d{2})(\\d{2})/ ? ($1 * 60 + $2) * 60 + $3 : undef"),
            subdirectory: None,
        }),
        (798, TagKitDef {
            id: 798,
        ...
        (773, TagKitDef {
            ...
            writable: true,
            notes: None,
            print_conv: PrintConvType::Expression("$val ? \"$val m\" : \"inf\""),
        ...
        (24, TagKitDef {
            ...
            groups: HashMap::new(),
            writable: false,
            notes: Some("the actual model name, no decoding necessary"),
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: None,
        }),
        ...
        (114, TagKitDef {
            ...
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: Some(SubDirectoryType::Binary { processor: process_tag_0x72_subdirectory }),
        }),
        (24, TagKitDef {
            id: 24,
            name: "Model",
            ...
            groups: HashMap::new(),
            writable: false,
            notes: Some("oddly different than CameraType values in JPEG images by the same camera"),
        ...
        (32768, TagKitDef {
            ...
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: Some(SubDirectoryType::Binary { processor: process_tag_0x8000_subdirectory }),
        }),
        (0, TagKitDef {
            id: 0,
            name: "RawInfoVersion",
