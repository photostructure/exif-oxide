//! Generated tag table definitions from Olympus::AFInfo
//!
...
/// Tag definitions for Olympus::AFInfo table
pub static OLYMPUS_AFINFO_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([(
        1580,
        TagInfo {
            name: "CAFSensitivity",
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = OLYMPUS_AFINFO_TAGS.get(&tag_id_u16) {
