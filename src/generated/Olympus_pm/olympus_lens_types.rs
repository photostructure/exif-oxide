//! Generated lookup table for olympusLensTypes from ExifTool's Olympus module
//!
...
/// Raw data for olympusLensTypes lookup table
static OLYMPUS_LENS_TYPES_DATA: &[(&str, &'static str)] = &[
    ("0 00 00", "None"),
...
pub static OLYMPUS_LENS_TYPES: LazyLock<HashMap<&str, &'static str>> =
    LazyLock::new(|| OLYMPUS_LENS_TYPES_DATA.iter().copied().collect());

/// Look up olympusLensTypes value by key
