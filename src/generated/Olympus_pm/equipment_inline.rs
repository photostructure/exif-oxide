...
static EQUIPMENT_CAMERA_TYPE2_DATA: &[(&'static str, &'static str)] = &[
    ("D4028", "X-2,C-50Z"),
...
pub fn lookup_equipment__camera_type2(key: &str) -> Option<&'static str> {
    EQUIPMENT_CAMERA_TYPE2.get(key).copied()
}

/// Raw data (4 entries)
static EQUIPMENT_FLASH_TYPE_DATA: &[(u8, &'static str)] = &[
    (0, "None"),
    (2, "Simple E-System"),
    (3, "E-System"),
...
pub fn lookup_equipment__flash_type(key: u8) -> Option<&'static str> {
    EQUIPMENT_FLASH_TYPE.get(&key).copied()
}

/// Raw data (12 entries)
static EQUIPMENT_FLASH_MODEL_DATA: &[(u8, &'static str)] = &[
    (0, "None"),
    (1, "FL-20"),
    (2, "FL-50"),
    (3, "RF-11"),
...
pub fn lookup_equipment__flash_model(key: u8) -> Option<&'static str> {
    EQUIPMENT_FLASH_MODEL.get(&key).copied()
}

/// Raw data (138 entries)
static EQUIPMENT_LENS_TYPE_DATA: &[(&'static str, &'static str)] = &[
    ("0 00 00", "None"),
...
pub fn lookup_equipment__lens_type(key: &str) -> Option<&'static str> {
    EQUIPMENT_LENS_TYPE.get(key).copied()
}

/// Raw data (4 entries)
static EQUIPMENT_EXTENDER_DATA: &[(&'static str, &'static str)] = &[
    ("0 00", "None"),
...
pub fn lookup_equipment__extender(key: &str) -> Option<&'static str> {
    EQUIPMENT_EXTENDER.get(key).copied()
}
