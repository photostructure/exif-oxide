//! Generated lookup table for olympusCameraTypes from ExifTool's Olympus module
//!
...
/// Raw data for olympusCameraTypes lookup table
static OLYMPUS_CAMERA_TYPES_DATA: &[(&str, &'static str)] = &[
    ("D4028", "X-2,C-50Z"),
...
/// olympusCameraTypes lookup table
pub static OLYMPUS_CAMERA_TYPES: LazyLock<HashMap<&str, &'static str>> =
    LazyLock::new(|| OLYMPUS_CAMERA_TYPES_DATA.iter().copied().collect());

/// Look up olympusCameraTypes value by key
