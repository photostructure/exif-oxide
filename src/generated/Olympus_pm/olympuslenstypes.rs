//! Olympus lens type codes to lens names lookup table
//!
...
// Generated olympus_lens_types lookup table
// DO NOT EDIT MANUALLY - changes will be overwritten by codegen
// Source: ExifTool Olympus.pm %olympusLensTypes
// Description: Olympus lens type codes to lens names

/// Static data for olympus lens type codes to lens names lookup (138 entries)
...
pub static OLYMPUS_LENS_TYPES: LazyLock<HashMap<&'static str, &'static str>> =
    LazyLock::new(|| OLYMPUS_LENS_TYPES_DATA.iter().copied().collect());

/// Look up olympus lens type codes to lens names value by key
pub fn lookup_olympus_lens_types(key: &str) -> Option<&'static str> {
    OLYMPUS_LENS_TYPES.get(key).copied()
}
