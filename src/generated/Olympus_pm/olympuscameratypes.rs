//! Olympus camera type codes to camera names lookup table
//!
...
// Generated olympus_camera_types lookup table
// DO NOT EDIT MANUALLY - changes will be overwritten by codegen
// Source: ExifTool Olympus.pm %olympusCameraTypes
// Description: Olympus camera type codes to camera names

/// Static data for olympus camera type codes to camera names lookup (303 entries)
...
/// Look up olympus camera type codes to camera names value by key
