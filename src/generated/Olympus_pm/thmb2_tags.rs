//! Generated tag table definitions from Olympus::thmb2
//!
...
/// Tag definitions for Olympus::thmb2 table
pub static OLYMPUS_THMB2_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            0,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = OLYMPUS_THMB2_TAGS.get(&tag_id_u16) {
