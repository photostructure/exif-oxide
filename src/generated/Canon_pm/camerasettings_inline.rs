...
//!
//! Auto-generated from third-party/exiftool/lib/Image/ExifTool/Canon.pm (table: CameraSettings)
...
/// Raw data (2 entries)
static CAMERA_SETTINGS_MACRO_MODE_DATA: &[(u8, &'static str)] = &[(1, "Macro"), (2, "Normal")];
...
/// Raw data (19 entries)
static CAMERA_SETTINGS_CANON_IMAGE_SIZE_DATA: &[(i16, &'static str)] = &[
    (-1, "n/a"),
    (0, "Large"),
    (1, "Medium"),
    (2, "Small"),
...
/// Lookup table (lazy-initialized)
pub static CAMERA_SETTINGS_CANON_IMAGE_SIZE: LazyLock<HashMap<i16, &'static str>> =
    LazyLock::new(|| {
        CAMERA_SETTINGS_CANON_IMAGE_SIZE_DATA
            .iter()
            .cloned()
            .collect()
    });
...
/// Look up value by key
pub fn lookup_camera_settings__canon_image_size(key: i16) -> Option<&'static str> {
    CAMERA_SETTINGS_CANON_IMAGE_SIZE.get(&key).copied()
}

/// Raw data (75 entries)
static CAMERA_SETTINGS_EASY_MODE_DATA: &[(u16, &'static str)] = &[
    (0, "Full auto"),
    (1, "Manual"),
    (2, "Landscape"),
    (3, "Fast shutter"),
...
/// Lookup table (lazy-initialized)
pub static CAMERA_SETTINGS_EASY_MODE: LazyLock<HashMap<u16, &'static str>> =
    LazyLock::new(|| CAMERA_SETTINGS_EASY_MODE_DATA.iter().cloned().collect());

/// Look up value by key
pub fn lookup_camera_settings__easy_mode(key: u16) -> Option<&'static str> {
    CAMERA_SETTINGS_EASY_MODE.get(&key).copied()
}

/// Raw data (4 entries)
static CAMERA_SETTINGS_DIGITAL_ZOOM_DATA: &[(u8, &'static str)] =
    &[(0, "None"), (1, "2x"), (2, "4x"), (3, "Other")];

/// Lookup table (lazy-initialized)
pub static CAMERA_SETTINGS_DIGITAL_ZOOM: LazyLock<HashMap<u8, &'static str>> =
    LazyLock::new(|| CAMERA_SETTINGS_DIGITAL_ZOOM_DATA.iter().cloned().collect());

/// Look up value by key
pub fn lookup_camera_settings__digital_zoom(key: u8) -> Option<&'static str> {
    CAMERA_SETTINGS_DIGITAL_ZOOM.get(&key).copied()
}

/// Raw data (6 entries)
static CAMERA_SETTINGS_METERING_MODE_DATA: &[(u8, &'static str)] = &[
    (0, "Default"),
    (1, "Spot"),
    (2, "Average"),
    (3, "Evaluative"),
...
/// Lookup table (lazy-initialized)
pub static CAMERA_SETTINGS_METERING_MODE: LazyLock<HashMap<u8, &'static str>> =
    LazyLock::new(|| CAMERA_SETTINGS_METERING_MODE_DATA.iter().cloned().collect());

/// Look up value by key
pub fn lookup_camera_settings__metering_mode(key: u8) -> Option<&'static str> {
    CAMERA_SETTINGS_METERING_MODE.get(&key).copied()
}

/// Raw data (11 entries)
static CAMERA_SETTINGS_FOCUS_RANGE_DATA: &[(u8, &'static str)] = &[
    (0, "Manual"),
    (1, "Auto"),
    (2, "Not Known"),
    (3, "Macro"),
...
/// Lookup table (lazy-initialized)
pub static CAMERA_SETTINGS_FOCUS_RANGE: LazyLock<HashMap<u8, &'static str>> =
    LazyLock::new(|| CAMERA_SETTINGS_FOCUS_RANGE_DATA.iter().cloned().collect());

/// Look up value by key
pub fn lookup_camera_settings__focus_range(key: u8) -> Option<&'static str> {
    CAMERA_SETTINGS_FOCUS_RANGE.get(&key).copied()
}

/// Raw data (8 entries)
static CAMERA_SETTINGS_A_F_POINT_DATA: &[(u16, &'static str)] = &[
...
/// Lookup table (lazy-initialized)
pub static CAMERA_SETTINGS_A_F_POINT: LazyLock<HashMap<u16, &'static str>> =
    LazyLock::new(|| CAMERA_SETTINGS_A_F_POINT_DATA.iter().cloned().collect());

/// Look up value by key
pub fn lookup_camera_settings__a_f_point(key: u16) -> Option<&'static str> {
    CAMERA_SETTINGS_A_F_POINT.get(&key).copied()
}

/// Raw data (9 entries)
static CAMERA_SETTINGS_CANON_EXPOSURE_MODE_DATA: &[(u8, &'static str)] = &[
    (0, "Easy"),
    (1, "Program AE"),
...
/// Lookup table (lazy-initialized)
pub static CAMERA_SETTINGS_CANON_EXPOSURE_MODE: LazyLock<HashMap<u8, &'static str>> =
    LazyLock::new(|| {
        CAMERA_SETTINGS_CANON_EXPOSURE_MODE_DATA
            .iter()
            .cloned()
            .collect()
    });
...
/// Look up value by key
pub fn lookup_camera_settings__canon_exposure_mode(key: u8) -> Option<&'static str> {
    CAMERA_SETTINGS_CANON_EXPOSURE_MODE.get(&key).copied()
}

/// Raw data (526 entries)
static CAMERA_SETTINGS_LENS_TYPE_DATA: &[(&'static str, &'static str)] = &[
    ("-1", "n/a"),
...
/// Lookup table (lazy-initialized)
pub static CAMERA_SETTINGS_LENS_TYPE: LazyLock<HashMap<&'static str, &'static str>> =
    LazyLock::new(|| CAMERA_SETTINGS_LENS_TYPE_DATA.iter().cloned().collect());

/// Look up value by key
pub fn lookup_camera_settings__lens_type(key: &str) -> Option<&'static str> {
    CAMERA_SETTINGS_LENS_TYPE.get(key).copied()
}

/// Raw data (1 entries)
static CAMERA_SETTINGS_FLASH_BITS_DATA: &[(u8, &'static str)] = &[(0, "(none)")];

/// Lookup table (lazy-initialized)
pub static CAMERA_SETTINGS_FLASH_BITS: LazyLock<HashMap<u8, &'static str>> =
    LazyLock::new(|| CAMERA_SETTINGS_FLASH_BITS_DATA.iter().cloned().collect());

/// Look up value by key
pub fn lookup_camera_settings__flash_bits(key: u8) -> Option<&'static str> {
    CAMERA_SETTINGS_FLASH_BITS.get(&key).copied()
}

/// Raw data (9 entries)
static CAMERA_SETTINGS_QUALITY_DATA: &[(i16, &'static str)] = &[
    (-1, "n/a"),
    (1, "Economy"),
    (2, "Normal"),
    (3, "Fine"),
...
/// Lookup table (lazy-initialized)
pub static CAMERA_SETTINGS_QUALITY: LazyLock<HashMap<i16, &'static str>> =
    LazyLock::new(|| CAMERA_SETTINGS_QUALITY_DATA.iter().cloned().collect());

/// Look up value by key
pub fn lookup_camera_settings__quality(key: i16) -> Option<&'static str> {
    CAMERA_SETTINGS_QUALITY.get(&key).copied()
}

/// Raw data (3 entries)
static CAMERA_SETTINGS_FOCUS_CONTINUOUS_DATA: &[(u8, &'static str)] =
    &[(0, "Single"), (1, "Continuous"), (8, "Manual")];

/// Lookup table (lazy-initialized)
pub static CAMERA_SETTINGS_FOCUS_CONTINUOUS: LazyLock<HashMap<u8, &'static str>> =
    LazyLock::new(|| {
        CAMERA_SETTINGS_FOCUS_CONTINUOUS_DATA
            .iter()
            .cloned()
            .collect()
    });
...
/// Look up value by key
pub fn lookup_camera_settings__focus_continuous(key: u8) -> Option<&'static str> {
    CAMERA_SETTINGS_FOCUS_CONTINUOUS.get(&key).copied()
}

/// Raw data (5 entries)
static CAMERA_SETTINGS_A_E_SETTING_DATA: &[(u8, &'static str)] = &[
    (0, "Normal AE"),
...
/// Lookup table (lazy-initialized)
pub static CAMERA_SETTINGS_A_E_SETTING: LazyLock<HashMap<u8, &'static str>> =
    LazyLock::new(|| CAMERA_SETTINGS_A_E_SETTING_DATA.iter().cloned().collect());

/// Look up value by key
pub fn lookup_camera_settings__a_e_setting(key: u8) -> Option<&'static str> {
    CAMERA_SETTINGS_A_E_SETTING.get(&key).copied()
}

/// Raw data (10 entries)
static CAMERA_SETTINGS_IMAGE_STABILIZATION_DATA: &[(u16, &'static str)] = &[
    (0, "Off"),
    (1, "On"),
    (2, "Shoot Only"),
    (3, "Panning"),
...
/// Lookup table (lazy-initialized)
pub static CAMERA_SETTINGS_IMAGE_STABILIZATION: LazyLock<HashMap<u16, &'static str>> =
    LazyLock::new(|| {
...
/// Look up value by key
pub fn lookup_camera_settings__image_stabilization(key: u16) -> Option<&'static str> {
    CAMERA_SETTINGS_IMAGE_STABILIZATION.get(&key).copied()
}

/// Raw data (2 entries)
static CAMERA_SETTINGS_SPOT_METERING_MODE_DATA: &[(u8, &'static str)] =
    &[(0, "Center"), (1, "AF Point")];

/// Lookup table (lazy-initialized)
pub static CAMERA_SETTINGS_SPOT_METERING_MODE: LazyLock<HashMap<u8, &'static str>> =
    LazyLock::new(|| {
        CAMERA_SETTINGS_SPOT_METERING_MODE_DATA
            .iter()
            .cloned()
            .collect()
    });
...
/// Look up value by key
pub fn lookup_camera_settings__spot_metering_mode(key: u8) -> Option<&'static str> {
    CAMERA_SETTINGS_SPOT_METERING_MODE.get(&key).copied()
}

/// Raw data (9 entries)
static CAMERA_SETTINGS_CANON_FLASH_MODE_DATA: &[(i16, &'static str)] = &[
    (-1, "n/a"),
    (0, "Off"),
    (1, "Auto"),
    (2, "On"),
...
/// Lookup table (lazy-initialized)
pub static CAMERA_SETTINGS_CANON_FLASH_MODE: LazyLock<HashMap<i16, &'static str>> =
    LazyLock::new(|| {
        CAMERA_SETTINGS_CANON_FLASH_MODE_DATA
            .iter()
            .cloned()
            .collect()
    });
...
/// Look up value by key
pub fn lookup_camera_settings__canon_flash_mode(key: i16) -> Option<&'static str> {
    CAMERA_SETTINGS_CANON_FLASH_MODE.get(&key).copied()
}

/// Raw data (8 entries)
static CAMERA_SETTINGS_PHOTO_EFFECT_DATA: &[(u8, &'static str)] = &[
    (0, "Off"),
    (1, "Vivid"),
    (2, "Neutral"),
    (3, "Smooth"),
...
/// Lookup table (lazy-initialized)
pub static CAMERA_SETTINGS_PHOTO_EFFECT: LazyLock<HashMap<u8, &'static str>> =
    LazyLock::new(|| CAMERA_SETTINGS_PHOTO_EFFECT_DATA.iter().cloned().collect());

/// Look up value by key
pub fn lookup_camera_settings__photo_effect(key: u8) -> Option<&'static str> {
    CAMERA_SETTINGS_PHOTO_EFFECT.get(&key).copied()
}

/// Raw data (5 entries)
static CAMERA_SETTINGS_MANUAL_FLASH_OUTPUT_DATA: &[(u16, &'static str)] = &[
    (0, "n/a"),
    (1280, "Full"),
    (1282, "Medium"),
    (1284, "Low"),
...
/// Lookup table (lazy-initialized)
pub static CAMERA_SETTINGS_MANUAL_FLASH_OUTPUT: LazyLock<HashMap<u16, &'static str>> =
    LazyLock::new(|| {
        CAMERA_SETTINGS_MANUAL_FLASH_OUTPUT_DATA
            .iter()
            .cloned()
            .collect()
    });
...
/// Look up value by key
pub fn lookup_camera_settings__manual_flash_output(key: u16) -> Option<&'static str> {
    CAMERA_SETTINGS_MANUAL_FLASH_OUTPUT.get(&key).copied()
}

/// Raw data (3 entries)
static CAMERA_SETTINGS_S_R_A_W_QUALITY_DATA: &[(u8, &'static str)] =
    &[(0, "n/a"), (1, "sRAW1 (mRAW)"), (2, "sRAW2 (sRAW)")];

/// Lookup table (lazy-initialized)
pub static CAMERA_SETTINGS_S_R_A_W_QUALITY: LazyLock<HashMap<u8, &'static str>> =
    LazyLock::new(|| {
        CAMERA_SETTINGS_S_R_A_W_QUALITY_DATA
            .iter()
            .cloned()
            .collect()
    });
...
/// Look up value by key
pub fn lookup_camera_settings__s_r_a_w_quality(key: u8) -> Option<&'static str> {
    CAMERA_SETTINGS_S_R_A_W_QUALITY.get(&key).copied()
}

/// Raw data (10 entries)
static CAMERA_SETTINGS_CONTINUOUS_DRIVE_DATA: &[(u8, &'static str)] = &[
    (0, "Single"),
    (1, "Continuous"),
    (2, "Movie"),
...
/// Lookup table (lazy-initialized)
pub static CAMERA_SETTINGS_CONTINUOUS_DRIVE: LazyLock<HashMap<u8, &'static str>> =
    LazyLock::new(|| {
        CAMERA_SETTINGS_CONTINUOUS_DRIVE_DATA
            .iter()
            .cloned()
            .collect()
    });
...
/// Look up value by key
pub fn lookup_camera_settings__continuous_drive(key: u8) -> Option<&'static str> {
    CAMERA_SETTINGS_CONTINUOUS_DRIVE.get(&key).copied()
}

/// Raw data (3 entries)
static CAMERA_SETTINGS_H_D_R__P_Q_DATA: &[(i16, &'static str)] =
    &[(-1, "n/a"), (0, "Off"), (1, "On")];

/// Lookup table (lazy-initialized)
pub static CAMERA_SETTINGS_H_D_R__P_Q: LazyLock<HashMap<i16, &'static str>> =
    LazyLock::new(|| CAMERA_SETTINGS_H_D_R__P_Q_DATA.iter().cloned().collect());

/// Look up value by key
pub fn lookup_camera_settings__h_d_r__p_q(key: i16) -> Option<&'static str> {
    CAMERA_SETTINGS_H_D_R__P_Q.get(&key).copied()
}

/// Raw data (13 entries)
static CAMERA_SETTINGS_FOCUS_MODE_DATA: &[(u16, &'static str)] = &[
    (0, "One-shot AF"),
    (1, "AI Servo AF"),
    (2, "AI Focus AF"),
    (3, "Manual Focus (3)"),
...
/// Lookup table (lazy-initialized)
pub static CAMERA_SETTINGS_FOCUS_MODE: LazyLock<HashMap<u16, &'static str>> =
    LazyLock::new(|| CAMERA_SETTINGS_FOCUS_MODE_DATA.iter().cloned().collect());

/// Look up value by key
pub fn lookup_camera_settings__focus_mode(key: u16) -> Option<&'static str> {
    CAMERA_SETTINGS_FOCUS_MODE.get(&key).copied()
}

/// Raw data (14 entries)
static CAMERA_SETTINGS_RECORD_MODE_DATA: &[(u8, &'static str)] = &[
    (1, "JPEG"),
    (2, "CRW+THM"),
    (3, "AVI+THM"),
    (4, "TIF"),
...
/// Lookup table (lazy-initialized)
pub static CAMERA_SETTINGS_RECORD_MODE: LazyLock<HashMap<u8, &'static str>> =
    LazyLock::new(|| CAMERA_SETTINGS_RECORD_MODE_DATA.iter().cloned().collect());

/// Look up value by key
pub fn lookup_camera_settings__record_mode(key: u8) -> Option<&'static str> {
    CAMERA_SETTINGS_RECORD_MODE.get(&key).copied()
}
