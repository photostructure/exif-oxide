...
static PRINT_CONV_51: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    let mut map = HashMap::new();
    map.insert("0".to_string(), "Disable");
...
static PRINT_CONV_100: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    let mut map = HashMap::new();
    map.insert("1".to_string(), "1 (1DmkIIN/5D/30D/400D)");
    map
});

static PRINT_CONV_101: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    let mut map = HashMap::new();
    map.insert("2".to_string(), "2 (1DmkIII)");
    map.insert("3".to_string(), "3 (40D)");
    map.insert("4".to_string(), "4 (1DSmkIII)");
    map.insert("5".to_string(), "5 (450D/1000D)");
    map.insert("6".to_string(), "6 (50D/5DmkII)");
    map.insert("7".to_string(), "7 (500D/550D/7D/1DmkIV)");
    map.insert("9".to_string(), "9 (60D/1100D)");
    map
});

static PRINT_CONV_102: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    let mut map = HashMap::new();
    map.insert("-3".to_string(), "-3 (M10/M3)");
    map.insert("-4".to_string(), "-4 (M100/M5/M6)");
    map
});

static PRINT_CONV_103: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    let mut map = HashMap::new();
    map.insert("10".to_string(), "10 (600D/1200D)");
    map
});
...
static PRINT_CONV_104: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    ...
    map.insert("11".to_string(), "11 (7DmkII/750D/760D/8000D)");
    map
});

static PRINT_CONV_105: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    let mut map = HashMap::new();
    map.insert("12".to_string(), "12 (1DXmkII/5DS/5DSR)");
    map.insert("13".to_string(), "13 (80D/5DmkIV)");
    map.insert("14".to_string(), "14 (1300D/2000D/4000D)");
    map.insert("15".to_string(), "15 (6DmkII/77D/200D/800D,9000D)");
    map
});

static PRINT_CONV_106: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    let mut map = HashMap::new();
    map.insert("16".to_string(), "16 (M50)");
    map.insert("17".to_string(), "17 (EOS R)");
    map.insert("18".to_string(), "18 (EOS RP/250D)");
    map.insert("19".to_string(), "19 (90D/850D/M6mkII/M200)");
    map
});

static PRINT_CONV_107: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    let mut map = HashMap::new();
    map.insert("32".to_string(), "32 (1DXmkIII)");
    map.insert("33".to_string(), "33 (R5/R6)");
    map
});

static PRINT_CONV_108: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    let mut map = HashMap::new();
    map.insert("34".to_string(), "34 (R3)");
    map.insert("48".to_string(), "48 (R7, R10, R6 Mark II)");
    map
});

static PRINT_CONV_109: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    let mut map = HashMap::new();
    map.insert("64".to_string(), "64 (R1, R5 Mark II)");
    map
});
...
pub fn get_other_tags() -> Vec<(u32, TagKitDef)> {
    vec![
        ...
        (148, TagKitDef {
            ...
            print_conv: PrintConvType::Expression("Image::ExifTool::Canon::PrintAFPoints1D($val)"),
            value_conv: None,
            subdirectory: None,
        }),
        (149, TagKitDef {
        ...
        (75, TagKitDef {
            ...
            groups: HashMap::new(),
            writable: false,
            notes: Some("A, B, C, Temperature"),
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: Some(SubDirectoryType::Binary { processor: process_tag_0x4b_subdirectory }),
        }),
        (103, TagKitDef {
            id: 103,
        ...
        (618, TagKitDef {
            ...
            groups: HashMap::new(),
            writable: false,
            notes: Some("raw MeasuredRGGB values, before normalization"),
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: None,
        }),
        ...
        (133, TagKitDef {
            ...
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: Some(SubDirectoryType::Binary { processor: process_tag_0x85_subdirectory }),
        }),
        (196, TagKitDef {
            id: 196,
        ...
        (584, TagKitDef {
            ...
            writable: false,
            notes: None,
            print_conv: PrintConvType::Expression("$val == 255 ? \"Strobe or Misfire\" : sprintf(\"%.0f%%\", $val * 100)"),
            value_conv: Some("$val >= 255 ? 255 : exp(($val-200)/16*log(2))"),
            subdirectory: None,
        }),
        (585, TagKitDef {
            id: 585,
            ...
            writable: false,
            notes: None,
            print_conv: PrintConvType::Expression("$val ? sprintf(\"%.2fV\", $val * 5 / 186) : \"n/a\""),
            value_conv: None,
            subdirectory: None,
        }),
        (586, TagKitDef {
        ...
        (647, TagKitDef {
            ...
            groups: HashMap::new(),
            writable: false,
            notes: Some("MeasuredRGGB may be derived from these data values"),
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: None,
        }),
        ...
        (186, TagKitDef {
            ...
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: Some(SubDirectoryType::Binary { processor: process_tag_0xba_subdirectory }),
        }),
        (662, TagKitDef {
            id: 662,
            name: "SpecularWhiteLevel",
        ...
        (71, TagKitDef {
            ...
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: Some(SubDirectoryType::Binary { processor: process_tag_0x47_subdirectory }),
        }),
        (71, TagKitDef {
            id: 71,
            name: "ColorCoefs2",
        ...
        (188, TagKitDef {
            ...
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: Some(SubDirectoryType::Binary { processor: process_tag_0xbc_subdirectory }),
        }),
        (251, TagKitDef {
            id: 251,
            name: "AverageBlackLevel",
        ...
        (213, TagKitDef {
            ...
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: Some(SubDirectoryType::Binary { processor: process_tag_0xd5_subdirectory }),
        }),
        (429, TagKitDef {
            id: 429,
            name: "RawMeasuredRGGB",
        ...
        (778, TagKitDef {
            ...
            groups: HashMap::new(),
            writable: false,
            notes: Some("5DS, 5DS R, 77D, 80D and 800D"),
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: None,
        }),
