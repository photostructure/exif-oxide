...
static PRINT_CONV_20: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    ...
    map.insert("1".to_string(), "Adjust all by the same amount");
    map.insert("2".to_string(), "Adjust by lens");
    map
});
...
static PRINT_CONV_43: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    ...
    map.insert("1".to_string(), "Art (standard)");
    map.insert("2".to_string(), "Art (vivid)");
    map.insert("3".to_string(), "Art (bold)");
    map.insert("4".to_string(), "Art (embossed)");
    map
});
...
static PRINT_CONV_47: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    ...
    map.insert("0".to_string(), "Off");
    map.insert("1".to_string(), "On");
    map.insert("2".to_string(), "Enhanced");
    map
});
...
static PRINT_CONV_50: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    let mut map = HashMap::new();
    map.insert("0".to_string(), "EOS Original");
...
static PRINT_CONV_51: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    let mut map = HashMap::new();
    map.insert("0".to_string(), "Editing (ALL-I)");
    map.insert("1".to_string(), "Standard (IPB)");
    map.insert("2".to_string(), "Light (IPB)");
    map.insert("3".to_string(), "Motion JPEG");
    map.insert("4".to_string(), "RAW");
    map
});
...
static PRINT_CONV_52: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    let mut map = HashMap::new();
    map.insert("0".to_string(), "BT.709");
    map.insert("1".to_string(), "BT.2020");
    map.insert("2".to_string(), "CinemaGamut");
    map
});
...
static PRINT_CONV_57: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    ...
    map.insert("0".to_string(), "Off");
    map.insert("1".to_string(), "On");
    map.insert("2".to_string(), "On (RAW)");
    map
});

static PRINT_CONV_58: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    let mut map = HashMap::new();
    map.insert("0".to_string(), "Additive");
    map.insert("1".to_string(), "Average");
    map.insert("2".to_string(), "Bright (comparative)");
    map.insert("3".to_string(), "Dark (comparative)");
    map
});
...
pub fn get_interop_tags() -> Vec<(u32, TagKitDef)> {
    vec![
        ...
        (7, TagKitDef {
            ...
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: Some(SubDirectoryType::Binary { processor: process_tag_0x7_subdirectory }),
        }),
        (8, TagKitDef {
            id: 8,
            name: "ExifInfo8",
            ...
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: Some(SubDirectoryType::Binary { processor: process_tag_0x8_subdirectory }),
        }),
        (9, TagKitDef {
            id: 9,
            name: "ExifInfo9",
            ...
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: Some(SubDirectoryType::Binary { processor: process_tag_0x9_subdirectory }),
        }),
        (3, TagKitDef {
            id: 3,
            name: "FNumber",
            ...
            value_conv: Some("exp(($val-8)/16*log(2))"),
            subdirectory: None,
        }),
        (6, TagKitDef {
            id: 6,
            ...
            value_conv: Some("100*exp(($val/8-9)*log(2))"),
            subdirectory: None,
        }),
        (10, TagKitDef {
            id: 10,
        ...
        (5, TagKitDef {
            ...
            notes: None,
            print_conv: PrintConvType::Expression("sprintf(\"%.2g\",$val)"),
            value_conv: Some("exp($val/192*log(2))"),
            subdirectory: None,
        }),
        (1, TagKitDef {
            id: 1,
            ...
            notes: None,
            print_conv: PrintConvType::Expression("sprintf(\"%.0f\",$val)"),
            value_conv: Some("100*exp((($val-411)/96)*log(2))"),
            subdirectory: None,
        }),
        (6, TagKitDef {
            id: 6,
        ...
        (2, TagKitDef {
            ...
            notes: None,
            print_conv: PrintConvType::None,
            value_conv: Some("$val & 0x7fffffff"),
            subdirectory: None,
        }),
        (10, TagKitDef {
            id: 10,
        ...
        (4, TagKitDef {
            ...
            print_conv: PrintConvType::None,
            value_conv: Some("$val > 1800 and $val -= 3600; -$val / 10"),
            subdirectory: None,
        }),
        (5, TagKitDef {
            id: 5,
        ...
        (8, TagKitDef {
            ...
            groups: HashMap::new(),
            writable: false,
            notes: Some("these seem to be min/max focal length without teleconverter, as opposed to\n            MinFocalLength and MaxFocalLength which include the effect of a\n            teleconverter"),
            print_conv: PrintConvType::Expression("\"$val mm\""),
            value_conv: Some("$val / 10"),
            subdirectory: None,
        }),
        ...
        (9, TagKitDef {
            ...
            groups: HashMap::new(),
            writable: false,
            notes: Some("coordinates for the area to the left or right of the image used to calculate\n            the average black level"),
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: None,
        }),
