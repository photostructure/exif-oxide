//! Generated tag table definitions from Canon::PSInfo2
//!
...
/// Tag definitions for Canon::PSInfo2 table
pub static CANON_PSINFO2_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (0, TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = CANON_PSINFO2_TAGS.get(&tag_id_u16) {
