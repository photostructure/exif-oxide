//! Generated tag table definitions from Canon::ColorInfo
//!
...
/// Tag definitions for Canon::ColorInfo table
pub static CANON_COLORINFO_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            1,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = CANON_COLORINFO_TAGS.get(&tag_id_u16) {
