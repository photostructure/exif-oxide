...
/// Raw data (2 entries)
static FOCAL_LENGTH_FOCAL_TYPE_DATA: &[(u8, &'static str)] = &[
    (1, "Fixed"),
    (2, "Zoom"),
];

/// Lookup table (lazy-initialized)
pub static FOCAL_LENGTH_FOCAL_TYPE: LazyLock<HashMap<u8, &'static str>> = LazyLock::new(|| {
    FOCAL_LENGTH_FOCAL_TYPE_DATA.iter().cloned().collect()
});
