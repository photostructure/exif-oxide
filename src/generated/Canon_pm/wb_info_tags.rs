//! Generated tag table definitions from Canon::WBInfo
//!
...
/// Tag definitions for Canon::WBInfo table
pub static CANON_WBINFO_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            2,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = CANON_WBINFO_TAGS.get(&tag_id_u16) {
