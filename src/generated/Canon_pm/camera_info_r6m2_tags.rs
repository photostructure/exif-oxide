//! Generated tag table definitions from Canon::CameraInfoR6m2
//!
...
/// Tag definitions for Canon::CameraInfoR6m2 table
pub static CANON_CAMERAINFOR6M2_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([(
        3369,
        TagInfo {
            name: "ShutterCount",
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = CANON_CAMERAINFOR6M2_TAGS.get(&tag_id_u16) {
