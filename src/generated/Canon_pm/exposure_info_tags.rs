//! Generated tag table definitions from Canon::ExposureInfo
//!
    ...
    HashMap::from([
        ...
        (
            ...
            TagInfo {
                ...
                format: "int32u",
                print_conv: None,
                value_conv: Some(ValueConv::Expression("$val & 0x7fffffff".to_string())),
            },
        ),
    ])
});
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = CANON_EXPOSUREINFO_TAGS.get(&tag_id_u16) {
