//! Generated tag table definitions from Canon::ColorData10
//!
...
/// Tag definitions for Canon::ColorData10 table
pub static CANON_COLORDATA10_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            0,
            TagInfo {
                ...
                print_conv: Some(PrintConv::Simple(std::collections::HashMap::from([
                    ("32".to_string(), "32 (1DXmkIII)"),
                    ("33".to_string(), "33 (R5/R6)"),
                ]))),
                value_conv: None,
            },
        ),
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = CANON_COLORDATA10_TAGS.get(&tag_id_u16) {
