//! Inline PrintConv tables for CameraInfo1D table
//! 
//! Auto-generated from third-party/exiftool/lib/Image/ExifTool/Canon.pm (table: CameraInfo1D)
...
static CAMERA_INFO1_D_LENS_TYPE_DATA: &[(&'static str, &'static str)] = &[
    ("-1", "n/a"),
...
pub static CAMERA_INFO1_D_LENS_TYPE: LazyLock<HashMap<&'static str, &'static str>> = LazyLock::new(|| {
    CAMERA_INFO1_D_LENS_TYPE_DATA.iter().cloned().collect()
});

/// Look up value by key
pub fn lookup_camera_info1_d__lens_type(key: &str) -> Option<&'static str> {
    CAMERA_INFO1_D_LENS_TYPE.get(key).copied()
}

/// Raw data (6 entries)
static CAMERA_INFO1_D_SHARPNESS_FREQUENCY_DATA: &[(u8, &'static str)] = &[
    (0, "n/a"),
    (1, "Lowest"),
    (2, "Low"),
    (3, "Standard"),
...
/// Lookup table (lazy-initialized)
pub static CAMERA_INFO1_D_SHARPNESS_FREQUENCY: LazyLock<HashMap<u8, &'static str>> = LazyLock::new(|| {
    CAMERA_INFO1_D_SHARPNESS_FREQUENCY_DATA.iter().cloned().collect()
});

/// Look up value by key
pub fn lookup_camera_info1_d__sharpness_frequency(key: u8) -> Option<&'static str> {
    CAMERA_INFO1_D_SHARPNESS_FREQUENCY.get(&key).copied()
}

/// Raw data (22 entries)
static CAMERA_INFO1_D_WHITE_BALANCE_DATA: &[(u8, &'static str)] = &[
    (0, "Auto"),
    (1, "Daylight"),
    (2, "Cloudy"),
    (3, "Tungsten"),
...
/// Lookup table (lazy-initialized)
pub static CAMERA_INFO1_D_WHITE_BALANCE: LazyLock<HashMap<u8, &'static str>> = LazyLock::new(|| {
    CAMERA_INFO1_D_WHITE_BALANCE_DATA.iter().cloned().collect()
});

/// Look up value by key
pub fn lookup_camera_info1_d__white_balance(key: u8) -> Option<&'static str> {
    CAMERA_INFO1_D_WHITE_BALANCE.get(&key).copied()
}

/// Raw data (6 entries)
static CAMERA_INFO1_D_SHARPNESS_FREQUENCY_71_DATA: &[(u8, &'static str)] = &[
    (0, "n/a"),
    (1, "Lowest"),
    (2, "Low"),
    (3, "Standard"),
...
/// Lookup table (lazy-initialized)
pub static CAMERA_INFO1_D_SHARPNESS_FREQUENCY_71: LazyLock<HashMap<u8, &'static str>> = LazyLock::new(|| {
    CAMERA_INFO1_D_SHARPNESS_FREQUENCY_71_DATA.iter().cloned().collect()
});

/// Look up value by key
pub fn lookup_camera_info1_d__sharpness_frequency_71(key: u8) -> Option<&'static str> {
    CAMERA_INFO1_D_SHARPNESS_FREQUENCY_71.get(&key).copied()
}

/// Raw data (22 entries)
static CAMERA_INFO1_D_WHITE_BALANCE_74_DATA: &[(u8, &'static str)] = &[
    (0, "Auto"),
    (1, "Daylight"),
    (2, "Cloudy"),
    (3, "Tungsten"),
...
/// Lookup table (lazy-initialized)
pub static CAMERA_INFO1_D_WHITE_BALANCE_74: LazyLock<HashMap<u8, &'static str>> = LazyLock::new(|| {
    CAMERA_INFO1_D_WHITE_BALANCE_74_DATA.iter().cloned().collect()
});

/// Look up value by key
pub fn lookup_camera_info1_d__white_balance_74(key: u8) -> Option<&'static str> {
    CAMERA_INFO1_D_WHITE_BALANCE_74.get(&key).copied()
}

/// Raw data (24 entries)
static CAMERA_INFO1_D_PICTURE_STYLE_DATA: &[(i32, &'static str)] = &[
    (0, "None"),
    (1, "Standard"),
    (2, "Portrait"),
    (3, "High Saturation"),
...
/// Lookup table (lazy-initialized)
pub static CAMERA_INFO1_D_PICTURE_STYLE: LazyLock<HashMap<i32, &'static str>> = LazyLock::new(|| {
    CAMERA_INFO1_D_PICTURE_STYLE_DATA.iter().cloned().collect()
});

/// Look up value by key
pub fn lookup_camera_info1_d__picture_style(key: i32) -> Option<&'static str> {
    CAMERA_INFO1_D_PICTURE_STYLE.get(&key).copied()
}

/// Raw data (24 entries)
static CAMERA_INFO1_D_PICTURE_STYLE_81_DATA: &[(i32, &'static str)] = &[
    (0, "None"),
    (1, "Standard"),
    (2, "Portrait"),
    (3, "High Saturation"),
...
/// Lookup table (lazy-initialized)
pub static CAMERA_INFO1_D_PICTURE_STYLE_81: LazyLock<HashMap<i32, &'static str>> = LazyLock::new(|| {
    CAMERA_INFO1_D_PICTURE_STYLE_81_DATA.iter().cloned().collect()
});

/// Look up value by key
pub fn lookup_camera_info1_d__picture_style_81(key: i32) -> Option<&'static str> {
    CAMERA_INFO1_D_PICTURE_STYLE_81.get(&key).copied()
}
