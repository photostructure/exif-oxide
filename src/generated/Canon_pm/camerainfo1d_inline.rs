...
pub static CAMERA_INFO1_D_LENS_TYPE: LazyLock<HashMap<&'static str, &'static str>> =
    LazyLock::new(|| CAMERA_INFO1_D_LENS_TYPE_DATA.iter().cloned().collect());
...
/// Lookup table (lazy-initialized)
pub static CAMERA_INFO1_D_SHARPNESS_FREQUENCY: LazyLock<HashMap<u8, &'static str>> =
    LazyLock::new(|| {
        CAMERA_INFO1_D_SHARPNESS_FREQUENCY_DATA
            .iter()
            .cloned()
            .collect()
    });
...
/// Lookup table (lazy-initialized)
pub static CAMERA_INFO1_D_WHITE_BALANCE: LazyLock<HashMap<u8, &'static str>> =
    LazyLock::new(|| CAMERA_INFO1_D_WHITE_BALANCE_DATA.iter().cloned().collect());
...
/// Lookup table (lazy-initialized)
pub static CAMERA_INFO1_D_SHARPNESS_FREQUENCY_71: LazyLock<HashMap<u8, &'static str>> =
    LazyLock::new(|| {
        CAMERA_INFO1_D_SHARPNESS_FREQUENCY_71_DATA
            .iter()
            .cloned()
            .collect()
    });
...
/// Lookup table (lazy-initialized)
pub static CAMERA_INFO1_D_WHITE_BALANCE_74: LazyLock<HashMap<u8, &'static str>> =
    LazyLock::new(|| {
        CAMERA_INFO1_D_WHITE_BALANCE_74_DATA
            .iter()
            .cloned()
            .collect()
    });
...
/// Lookup table (lazy-initialized)
pub static CAMERA_INFO1_D_PICTURE_STYLE: LazyLock<HashMap<i32, &'static str>> =
    LazyLock::new(|| CAMERA_INFO1_D_PICTURE_STYLE_DATA.iter().cloned().collect());
...
/// Lookup table (lazy-initialized)
pub static CAMERA_INFO1_D_PICTURE_STYLE_81: LazyLock<HashMap<i32, &'static str>> =
    LazyLock::new(|| {
        CAMERA_INFO1_D_PICTURE_STYLE_81_DATA
            .iter()
            .cloned()
            .collect()
    });
