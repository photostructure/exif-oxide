//! Generated tag table definitions from Canon::CropInfo
//!
...
/// Tag definitions for Canon::CropInfo table
pub static CANON_CROPINFO_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = CANON_CROPINFO_TAGS.get(&tag_id_u16) {
