//! Generated tag table definitions from Canon::CDI1
//!
...
/// Tag definitions for Canon::CDI1 table
pub static CANON_CDI1_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = CANON_CDI1_TAGS.get(&tag_id_u16) {
