//! Generated lookup table for canonModelID from ExifTool's Canon module
//!
...
/// Raw data for canonModelID lookup table
...
/// canonModelID lookup table
pub static CANON_MODEL_ID: LazyLock<HashMap<u32, &'static str>> =
    LazyLock::new(|| CANON_MODEL_ID_DATA.iter().copied().collect());

/// Look up canonModelID value by key
