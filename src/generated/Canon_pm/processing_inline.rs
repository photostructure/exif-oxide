...
pub fn lookup_processing__tone_curve(key: u8) -> Option<&'static str> {
    PROCESSING_TONE_CURVE.get(&key).copied()
}

/// Raw data (24 entries)
static PROCESSING_PICTURE_STYLE_DATA: &[(i32, &'static str)] = &[
    (0, "None"),
    (1, "Standard"),
    (2, "Portrait"),
    (3, "High Saturation"),
...
pub fn lookup_processing__picture_style(key: i32) -> Option<&'static str> {
    PROCESSING_PICTURE_STYLE.get(&key).copied()
}

/// Raw data (6 entries)
static PROCESSING_SHARPNESS_FREQUENCY_DATA: &[(u8, &'static str)] = &[
    (0, "n/a"),
    (1, "Lowest"),
    (2, "Low"),
    (3, "Standard"),
...
pub fn lookup_processing__sharpness_frequency(key: u8) -> Option<&'static str> {
    PROCESSING_SHARPNESS_FREQUENCY.get(&key).copied()
}

/// Raw data (22 entries)
static PROCESSING_WHITE_BALANCE_DATA: &[(u8, &'static str)] = &[
    (0, "Auto"),
    (1, "Daylight"),
    (2, "Cloudy"),
    (3, "Tungsten"),
...
pub fn lookup_processing__white_balance(key: u8) -> Option<&'static str> {
    PROCESSING_WHITE_BALANCE.get(&key).copied()
}
