//! Canon lens type identification database lookup table
//!
...
// Generated canon_lens_types lookup table
// DO NOT EDIT MANUALLY - changes will be overwritten by codegen
// Source: ExifTool Canon.pm %canonLensTypes
// Description: Canon lens type identification database

/// Static data for canon lens type identification database lookup (526 entries)
...
/// Look up canon lens type identification database value by key
pub fn lookup_canon_lens_types(key: &str) -> Option<&'static str> {
    CANON_LENS_TYPES.get(key).copied()
}
