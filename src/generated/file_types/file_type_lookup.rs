...
//!
//! Generated at: Thu Jul 10 22:26:34 2025 GMT
//! Total lookups: 343
...
static FILE_TYPE_FORMATS: Lazy<HashMap<&'static str, (Vec<&'static str>, &'static str)>> = Lazy::new(|| {
    let mut map = HashMap::new();
    map.insert("360", (vec!["MOV"], "GoPro 360 video"));
    map.insert("3FR", (vec!["TIFF"], "Hasselblad RAW format"));
    map.insert("3G2", (vec!["MOV"], "3rd Gen. Partnership Project 2 audio/video"));
    map.insert("3GP", (vec!["MOV"], "3rd Gen. Partnership Project audio/video"));
    ...
    map.insert("ACR", (vec!["DICOM"], "American College of Radiology ACR-NEMA"));
    map.insert("AFM", (vec!["Font"], "Adobe Font Metrics"));
    map.insert("AI", (vec!["PDF", "PS"], "Adobe Illustrator"));
    map.insert("AIFC", (vec!["AIFF"], "Audio Interchange File Format Compressed"));
    ...
    map.insert("C2PA", (vec!["JUMBF"], "Coalition for Content Provenance and Authenticity"));
    ...
    map.insert("DICM", (vec!["DICOM"], "Digital Imaging and Communications in Medicine"));
    ...
    map.insert("DOCM", (vec!["ZIP", "FPX"], "Office Open XML Document Macro-enabled"));
    map.insert("DOCX", (vec!["ZIP", "FPX"], "Office Open XML Document"));
    map.insert("DOT", (vec!["FPX"], "Microsoft Word Template"));
    map.insert("DOTM", (vec!["ZIP", "FPX"], "Office Open XML Document Template Macro-enabled"));
    map.insert("DOTX", (vec!["ZIP", "FPX"], "Office Open XML Document Template"));
    ...
    map.insert("FFF", (vec!["TIFF", "FLIR"], "Hasselblad Flexible File Format"));
    ...
    map.insert("GIF", (vec!["GIF"], "Compuserve Graphics Interchange Format"));
    ...
    map.insert("HEIC", (vec!["MOV"], "High Efficiency Image Format still image"));
    ...
    map.insert("IIQ", (vec!["TIFF"], "Phase One Intelligent Image Quality RAW"));
    ...
    map.insert("JUMBF", (vec!["JUMBF"], "JPEG Universal Metadata Box Format"));
    ...
    map.insert("MIE", (vec!["MIE"], "Meta Information Encapsulation format"));
    ...
    map.insert("PAC", (vec!["RIFF"], "Lossless Predictive Audio Compression"));
    ...
    map.insert("POTM", (vec!["ZIP", "FPX"], "Office Open XML Presentation Template Macro-enabled"));
    map.insert("POTX", (vec!["ZIP", "FPX"], "Office Open XML Presentation Template"));
    map.insert("PPAM", (vec!["ZIP", "FPX"], "Office Open XML Presentation Addin Macro-enabled"));
    map.insert("PPAX", (vec!["ZIP", "FPX"], "Office Open XML Presentation Addin"));
    map.insert("PPM", (vec!["PPM"], "Portable Pixel Map"));
    map.insert("PPS", (vec!["FPX"], "Microsoft PowerPoint Slideshow"));
    map.insert("PPSM", (vec!["ZIP", "FPX"], "Office Open XML Presentation Slideshow Macro-enabled"));
    map.insert("PPSX", (vec!["ZIP", "FPX"], "Office Open XML Presentation Slideshow"));
    map.insert("PPT", (vec!["FPX"], "Microsoft PowerPoint Presentation"));
    map.insert("PPTM", (vec!["ZIP", "FPX"], "Office Open XML Presentation Macro-enabled"));
    ...
    map.insert("RAW", (vec!["RAW", "TIFF"], "Kyocera Contax N Digital RAW or Panasonic RAW"));
    ...
    map.insert("VNT", (vec!["FPX", "VCard"], "Scene7 Vignette or V-Note text file"));
    ...
    map.insert("XHTML", (vec!["HTML"], "Extensible HyperText Markup Language"));
    map.insert("XISF", (vec!["XISF"], "Extensible Image Serialization Format"));
    map.insert("XLA", (vec!["FPX"], "Microsoft Excel Add-in"));
    map.insert("XLAM", (vec!["ZIP", "FPX"], "Office Open XML Spreadsheet Add-in Macro-enabled"));
    map.insert("XLS", (vec!["FPX"], "Microsoft Excel Spreadsheet"));
    map.insert("XLSB", (vec!["ZIP", "FPX"], "Office Open XML Spreadsheet Binary"));
    map.insert("XLSM", (vec!["ZIP", "FPX"], "Office Open XML Spreadsheet Macro-enabled"));
    map.insert("XLSX", (vec!["ZIP", "FPX"], "Office Open XML Spreadsheet"));
    map.insert("XLT", (vec!["FPX"], "Microsoft Excel Template"));
    map.insert("XLTM", (vec!["ZIP", "FPX"], "Office Open XML Spreadsheet Template Macro-enabled"));
    map.insert("XLTX", (vec!["ZIP", "FPX"], "Office Open XML Spreadsheet Template"));
...
pub fn get_primary_format(file_type: &str) -> Option<String> {
    resolve_file_type(file_type)
        .map(|(formats, _)| formats[0].to_string())
}
