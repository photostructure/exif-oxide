//! Generated tag table definitions from Kodak::Unknown
//!
...
/// Tag definitions for Kodak::Unknown table
pub static KODAK_UNKNOWN_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = KODAK_UNKNOWN_TAGS.get(&tag_id_u16) {
