//! Generated tag table definitions from Kodak::SubIFD4
//!
...
/// Tag definitions for Kodak::SubIFD4 table
pub static KODAK_SUBIFD4_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = KODAK_SUBIFD4_TAGS.get(&tag_id_u16) {
