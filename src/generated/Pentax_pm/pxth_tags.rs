//! Generated tag table definitions from Pentax::PXTH
//!
...
/// Tag definitions for Pentax::PXTH table
pub static PENTAX_PXTH_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            0,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = PENTAX_PXTH_TAGS.get(&tag_id_u16) {
