//! Generated tag table definitions from Pentax::S1
//!
...
/// Tag definitions for Pentax::S1 table
pub static PENTAX_S1_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([(
        0,
        TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = PENTAX_S1_TAGS.get(&tag_id_u16) {
