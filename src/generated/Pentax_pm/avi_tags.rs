//! Generated tag table definitions from Pentax::AVI
//!
...
/// Tag definitions for Pentax::AVI table
pub static PENTAX_AVI_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = PENTAX_AVI_TAGS.get(&tag_id_u16) {
