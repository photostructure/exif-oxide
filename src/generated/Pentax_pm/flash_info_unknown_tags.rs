//! Generated tag table definitions from Pentax::FlashInfoUnknown
//!
...
/// Tag definitions for Pentax::FlashInfoUnknown table
pub static PENTAX_FLASHINFOUNKNOWN_TAGS: LazyLock<HashMap<u16, TagInfo>> =
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = PENTAX_FLASHINFOUNKNOWN_TAGS.get(&tag_id_u16) {
