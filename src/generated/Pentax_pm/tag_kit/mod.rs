...
//!
//! Generated from: Pentax.pm table: Main
//!
...
pub fn process_tag_0x207_subdirectory(
    ...
    match count {
        // Model condition not yet supported: $$self{Model}=~/(\\*ist|GX-1[LS])/ or ($$self{Model}=~/(K100D|K110D)/ and $$valPt=~/^.{20}(\\xff|\\0\\0)/s)
        // Would dispatch to: Image::ExifTool::Pentax::LensInfo
...
pub fn apply_print_conv(
    ...
    match tag_id {
        ...
        1 => crate::implementations::print_conv::decimal_1_print_conv(value),
        3 => crate::implementations::print_conv::focal_length_mm_print_conv(value),
        5 => crate::implementations::print_conv::exposuretime_print_conv(value),
        9 => crate::implementations::print_conv::decimal_1_print_conv(value),
        10 => crate::implementations::print_conv::decimal_1_print_conv(value),
        18 => crate::implementations::print_conv::exposuretime_print_conv(value),
        19 => crate::implementations::print_conv::decimal_1_print_conv(value),
        29 => crate::implementations::print_conv::focallength_print_conv(value),
        45 => crate::implementations::print_conv::decimal_1_print_conv(value),
...
pub fn apply_value_conv(
    ...
    match tag_id {
        ...
        2 => {
            // Compiled arithmetic: $val / 60
            match value.as_f64() {
                Some(val) => Ok(TagValue::F64(val / 60.0)),
                None => Ok(value.clone()),
            }
        }
        4 => {
        ...
        45 => {
            ...
            match value.as_f64() {
                Some(val) => Ok(TagValue::F64(val / 1024.0)),
                None => Ok(value.clone()),
            }
        }
        64 => {
