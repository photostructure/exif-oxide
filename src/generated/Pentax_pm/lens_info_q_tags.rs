//! Generated tag table definitions from Pentax::LensInfoQ
//!
    ...
    HashMap::from([
        ...
        (
            ...
            TagInfo {
                ...
                format: "string[20]",
                print_conv: None,
                value_conv: Some(ValueConv::Expression("$val=~s/mm/mm /; $val".to_string())),
            },
        ),
    ])
});
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = PENTAX_LENSINFOQ_TAGS.get(&tag_id_u16) {
