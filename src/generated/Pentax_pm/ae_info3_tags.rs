    ...
    HashMap::from([
        (
            ...
            TagInfo {
                ...
                value_conv: Some(ValueConv::Expression(
                    "24*exp(-($val-32)*log(2)/8)".to_string(),
                )),
            },
        ),
        (
        ...
        (
            ...
            TagInfo {
                name: "AE_ISO",
                format: "unknown",
                print_conv: Some(PrintConv::Expression("int($val + 0.5)".to_string())),
                value_conv: Some(ValueConv::Expression(
                    "100*exp(($val-32)*log(2)/8)".to_string(),
                )),
            },
        ),
        (
