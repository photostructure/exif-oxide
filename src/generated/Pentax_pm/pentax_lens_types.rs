//! Generated lookup table for pentaxLensTypes from ExifTool's Pentax module
//!
...
/// Raw data for pentaxLensTypes lookup table
static PENTAX_LENS_TYPES_DATA: &[(&str, &'static str)] = &[
    ("0 0", "M-42 or No Lens"),
    ("1 0", "K or M Lens"),
    ...
    ("OTHER", "[Function: Image::ExifTool::Pentax::__ANON__]"),
];

/// pentaxLensTypes lookup table
pub static PENTAX_LENS_TYPES: LazyLock<HashMap<&str, &'static str>> =
    LazyLock::new(|| PENTAX_LENS_TYPES_DATA.iter().copied().collect());

/// Look up pentaxLensTypes value by key
pub fn lookup_pentax_lens_types(key: &str) -> Option<&'static str> {
    PENTAX_LENS_TYPES.get(&key).copied()
}
