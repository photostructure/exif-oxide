//! Generated tag table definitions from HP::Main
//!
...
/// Tag definitions for HP::Main table
pub static HP_MAIN_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([(
        3584,
        TagInfo {
            name: "PrintIM",
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = HP_MAIN_TAGS.get(&tag_id_u16) {
