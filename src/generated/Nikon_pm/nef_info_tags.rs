//! Generated tag table definitions from Nikon::NEFInfo
//!
...
/// Tag definitions for Nikon::NEFInfo table
pub static NIKON_NEFINFO_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            5,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = NIKON_NEFINFO_TAGS.get(&tag_id_u16) {
