//! Generated tag table definitions from Nikon::ShotInfoD810
//!
...
/// Tag definitions for Nikon::ShotInfoD810 table
pub static NIKON_SHOTINFOD810_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            0,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = NIKON_SHOTINFOD810_TAGS.get(&tag_id_u16) {
