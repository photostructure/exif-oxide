//! Generated tag table definitions from Nikon::DistortionInfo
//!
    ...
    HashMap::from([
        ...
        (
            ...
            TagInfo {
                ...
                format: "rational64s",
                print_conv: Some(PrintConv::Expression("sprintf(\"%.5f\",$val)".to_string())),
                value_conv: None,
            },
        ),
        (
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = NIKON_DISTORTIONINFO_TAGS.get(&tag_id_u16) {
