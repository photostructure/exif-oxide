//! Generated tag table definitions from Nikon::MenuInfoZ9
//!
...
pub static NIKON_MENUINFOZ9_TAGS: LazyLock<HashMap<u16, TagInfo>> =
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = NIKON_MENUINFOZ9_TAGS.get(&tag_id_u16) {
