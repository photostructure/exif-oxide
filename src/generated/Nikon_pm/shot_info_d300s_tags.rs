//! Generated tag table definitions from Nikon::ShotInfoD300S
//!
...
/// Tag definitions for Nikon::ShotInfoD300S table
pub static NIKON_SHOTINFOD300S_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            0,
            TagInfo {
        ...
        (
            ...
            TagInfo {
                ...
                value_conv: Some(ValueConv::Expression(
                    "100*exp(($val/12-5)*log(2))".to_string(),
                )),
            },
        ),
        (
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = NIKON_SHOTINFOD300S_TAGS.get(&tag_id_u16) {
