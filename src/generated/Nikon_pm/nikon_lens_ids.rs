//! Generated lookup table for nikonLensIDs from ExifTool's Nikon module
//!
...
/// Raw data for nikonLensIDs lookup table
static NIKON_LENS_IDS_DATA: &[(&str, &'static str)] = &[
    ...
    ("OTHER", "[Function: Image::ExifTool::Nikon::LensIDConv]"),
];

/// nikonLensIDs lookup table
pub static NIKON_LENS_IDS: LazyLock<HashMap<&str, &'static str>> =
    LazyLock::new(|| NIKON_LENS_IDS_DATA.iter().copied().collect());

/// Look up nikonLensIDs value by key
