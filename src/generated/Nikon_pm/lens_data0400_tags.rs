//! Generated tag table definitions from Nikon::LensData0400
//!
...
/// Tag definitions for Nikon::LensData0400 table
pub static NIKON_LENSDATA0400_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            0,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = NIKON_LENSDATA0400_TAGS.get(&tag_id_u16) {
