//! Generated tag table definitions from Nikon::ShotInfoD3b
//!
...
/// Tag definitions for Nikon::ShotInfoD3b table
pub static NIKON_SHOTINFOD3B_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            0,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = NIKON_SHOTINFOD3B_TAGS.get(&tag_id_u16) {
