//! Generated tag table definitions from Nikon::FlashInfo0300
//!
...
use crate::generated::functions::hash_62::ast_value_62786f400980bd6c;
use crate::generated::functions::hash_96::ast_print_965cc8da10a90f1;
use crate::generated::functions::hash_a2::ast_print_a2e2c62119aee928;
...
/// Tag definitions for Nikon::FlashInfo0300 table
pub static NIKON_FLASHINFO0300_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            0,
            TagInfo {
        ...
        (
            ...
            TagInfo {
                name: "FlashOutput",
                format: "unknown",
                print_conv: Some(PrintConv::Function(ast_print_a2e2c62119aee928)),
        ...
        (
            ...
            TagInfo {
                ...
                value_conv: Some(ValueConv::Function(ast_value_62786f400980bd6c)),
                is_offset: false,
            },
        ),
        (
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = NIKON_FLASHINFO0300_TAGS.get(&tag_id_u16) {
