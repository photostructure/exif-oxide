//! Generated tag table definitions from Nikon::RotationInfoD500
//!
        ...
        (
            ...
            TagInfo {
                ...
                print_conv: Some(PrintConv::Expression(
                    "$val > 0 ? sprintf(\"%.0f\", $val) : \"\"".to_string(),
                )),
                value_conv: None,
            },
        ),
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = NIKON_ROTATIONINFOD500_TAGS.get(&tag_id_u16) {
