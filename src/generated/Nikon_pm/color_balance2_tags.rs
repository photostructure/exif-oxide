//! Generated tag table definitions from Nikon::ColorBalance2
//!
...
/// Tag definitions for Nikon::ColorBalance2 table
pub static NIKON_COLORBALANCE2_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([(
        0,
        TagInfo {
            name: "WB_RGGBLevels",
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = NIKON_COLORBALANCE2_TAGS.get(&tag_id_u16) {
