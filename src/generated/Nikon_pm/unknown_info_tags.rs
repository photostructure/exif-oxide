//! Generated tag table definitions from Nikon::UnknownInfo
//!
...
/// Tag definitions for Nikon::UnknownInfo table
pub static NIKON_UNKNOWNINFO_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([(
        0,
        TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = NIKON_UNKNOWNINFO_TAGS.get(&tag_id_u16) {
