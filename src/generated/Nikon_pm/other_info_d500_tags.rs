//! Generated tag table definitions from Nikon::OtherInfoD500
//!
...
/// Tag definitions for Nikon::OtherInfoD500 table
pub static NIKON_OTHERINFOD500_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([(
        532,
        TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = NIKON_OTHERINFOD500_TAGS.get(&tag_id_u16) {
