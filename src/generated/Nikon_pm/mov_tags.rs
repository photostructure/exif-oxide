//! Generated tag table definitions from Nikon::MOV
//!
...
/// Tag definitions for Nikon::MOV table
pub static NIKON_MOV_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            0,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = NIKON_MOV_TAGS.get(&tag_id_u16) {
