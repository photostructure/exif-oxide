//! Generated tag table definitions from Nikon::FlashInfo0103
//!
...
/// Tag definitions for Nikon::FlashInfo0103 table
pub static NIKON_FLASHINFO0103_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            0,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = NIKON_FLASHINFO0103_TAGS.get(&tag_id_u16) {
