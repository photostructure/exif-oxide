//! Generated tag table definitions from Sigma::WBSettings
//!
...
/// Tag definitions for Sigma::WBSettings table
pub static SIGMA_WBSETTINGS_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            0,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = SIGMA_WBSETTINGS_TAGS.get(&tag_id_u16) {
