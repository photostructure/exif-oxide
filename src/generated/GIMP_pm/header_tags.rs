//! Generated tag table definitions from GIMP::Header
//!
...
/// Tag definitions for GIMP::Header table
pub static GIMP_HEADER_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            9,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = GIMP_HEADER_TAGS.get(&tag_id_u16) {
