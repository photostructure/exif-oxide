//! Generated tag table definitions from CanonCustom::Functions400D
//!
...
/// Tag definitions for CanonCustom::Functions400D table
pub static CANON_CUSTOM_FUNCTIONS400D_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            0,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = CANON_CUSTOM_FUNCTIONS400D_TAGS.get(&tag_id_u16) {
