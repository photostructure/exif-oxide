//! Generated tag table definitions from CanonCustom::Functions20D
//!
...
/// Tag definitions for CanonCustom::Functions20D table
pub static CANON_CUSTOM_FUNCTIONS20D_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            0,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = CANON_CUSTOM_FUNCTIONS20D_TAGS.get(&tag_id_u16) {
