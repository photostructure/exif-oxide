//! Generated tag table definitions from XMP::sArea
//!
...
/// Tag definitions for XMP::sArea table
pub static XMP_SAREA_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = XMP_SAREA_TAGS.get(&tag_id_u16) {
