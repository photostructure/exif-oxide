//! Generated tag table definitions from XMP::xmpNote
//!
...
/// Tag definitions for XMP::xmpNote table
pub static XMP_XMPNOTE_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = XMP_XMPNOTE_TAGS.get(&tag_id_u16) {
