//! Generated tag table definitions from XMP::photoshop
//!
...
/// Tag definitions for XMP::photoshop table
pub static XMP_PHOTOSHOP_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = XMP_PHOTOSHOP_TAGS.get(&tag_id_u16) {
