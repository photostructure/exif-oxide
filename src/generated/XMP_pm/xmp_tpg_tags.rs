//! Generated tag table definitions from XMP::xmpTPg
//!
...
/// Tag definitions for XMP::xmpTPg table
pub static XMP_XMPTPG_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = XMP_XMPTPG_TAGS.get(&tag_id_u16) {
