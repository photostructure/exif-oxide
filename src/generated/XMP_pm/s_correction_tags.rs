//! Generated tag table definitions from XMP::sCorrection
//!
...
/// Tag definitions for XMP::sCorrection table
pub static XMP_SCORRECTION_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = XMP_SCORRECTION_TAGS.get(&tag_id_u16) {
