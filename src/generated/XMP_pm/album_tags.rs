//! Generated tag table definitions from XMP::Album
//!
...
/// Tag definitions for XMP::Album table
pub static XMP_ALBUM_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = XMP_ALBUM_TAGS.get(&tag_id_u16) {
