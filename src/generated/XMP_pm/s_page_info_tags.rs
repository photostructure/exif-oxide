//! Generated tag table definitions from XMP::sPageInfo
//!
...
/// Tag definitions for XMP::sPageInfo table
pub static XMP_SPAGEINFO_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = XMP_SPAGEINFO_TAGS.get(&tag_id_u16) {
