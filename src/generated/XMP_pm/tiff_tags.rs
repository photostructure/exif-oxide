//! Generated tag table definitions from XMP::tiff
//!
...
/// Tag definitions for XMP::tiff table
pub static XMP_TIFF_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = XMP_TIFF_TAGS.get(&tag_id_u16) {
