//! Generated tag table definitions from XMP::exifEX
//!
...
/// Tag definitions for XMP::exifEX table
pub static XMP_EXIFEX_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = XMP_EXIFEX_TAGS.get(&tag_id_u16) {
