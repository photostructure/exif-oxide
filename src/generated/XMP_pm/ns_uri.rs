//! Generated lookup table for nsURI from ExifTool's XMP module
//!
...
/// Raw data for nsURI lookup table
static NS_URI_DATA: &[(&str, &'static str)] = &[
...
/// nsURI lookup table
pub static NS_URI: LazyLock<HashMap<&str, &'static str>> =
    LazyLock::new(|| NS_URI_DATA.iter().copied().collect());

/// Look up nsURI value by key
pub fn lookup_ns_uri(key: &str) -> Option<&'static str> {
    NS_URI.get(&key).copied()
}
