//! Generated tag table definitions from RIFF::OpenDML
//!
...
/// Tag definitions for RIFF::OpenDML table
pub static RIFF_OPENDML_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = RIFF_OPENDML_TAGS.get(&tag_id_u16) {
