//! Generated tag table definitions from RIFF::DS64
//!
...
/// Tag definitions for RIFF::DS64 table
pub static RIFF_DS64_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            0,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = RIFF_DS64_TAGS.get(&tag_id_u16) {
