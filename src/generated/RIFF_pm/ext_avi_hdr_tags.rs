//! Generated tag table definitions from RIFF::ExtAVIHdr
//!
...
/// Tag definitions for RIFF::ExtAVIHdr table
pub static RIFF_EXTAVIHDR_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = RIFF_EXTAVIHDR_TAGS.get(&tag_id_u16) {
