//! Generated tag table definitions from Samsung::svss
//!
...
/// Tag definitions for Samsung::svss table
pub static SAMSUNG_SVSS_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = SAMSUNG_SVSS_TAGS.get(&tag_id_u16) {
