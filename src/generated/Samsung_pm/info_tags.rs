//! Generated tag table definitions from Samsung::INFO
//!
...
/// Tag definitions for Samsung::INFO table
pub static SAMSUNG_INFO_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = SAMSUNG_INFO_TAGS.get(&tag_id_u16) {
