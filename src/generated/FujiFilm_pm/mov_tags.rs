//! Generated tag table definitions from FujiFilm::MOV
//!
    ...
    HashMap::from([
        ...
        (
            ...
            TagInfo {
                ...
                value_conv: Some(ValueConv::Expression("$val ? 1 / $val : 0".to_string())),
            },
        ),
        (
            50,
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = FUJI_FILM_MOV_TAGS.get(&tag_id_u16) {
