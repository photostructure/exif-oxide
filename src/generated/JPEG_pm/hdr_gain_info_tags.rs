//! Generated tag table definitions from JPEG::HDRGainInfo
//!
...
/// Tag definitions for JPEG::HDRGainInfo table
pub static JPEG_HDRGAININFO_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            6,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = JPEG_HDRGAININFO_TAGS.get(&tag_id_u16) {
