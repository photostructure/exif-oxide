//! Generated tag table definitions from JPEG::GraphConv
//!
...
/// Tag definitions for JPEG::GraphConv table
pub static JPEG_GRAPHCONV_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = JPEG_GRAPHCONV_TAGS.get(&tag_id_u16) {
