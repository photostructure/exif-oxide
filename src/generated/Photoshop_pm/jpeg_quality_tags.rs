//! Generated tag table definitions from Photoshop::JPEG_Quality
//!
    ...
    HashMap::from([
        (
            ...
            TagInfo {
                ...
                format: "unknown",
                print_conv: Some(PrintConv::Expression("$val + 4".to_string())),
                value_conv: None,
            },
        ),
        (
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = PHOTOSHOP_JPEG_QUALITY_TAGS.get(&tag_id_u16) {
