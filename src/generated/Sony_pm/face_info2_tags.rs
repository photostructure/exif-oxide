//! Generated tag table definitions from Sony::FaceInfo2
//!
...
/// Tag definitions for Sony::FaceInfo2 table
pub static SONY_FACEINFO2_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            0,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = SONY_FACEINFO2_TAGS.get(&tag_id_u16) {
