...
/// Raw data (2 entries)
static EXTRA_INFO3_IMAGE_STABILIZATION_DATA: &[(u8, &'static str)] = &[
    (0, "Off"),
    (64, "On"),
];

/// Lookup table (lazy-initialized)
pub static EXTRA_INFO3_IMAGE_STABILIZATION: LazyLock<HashMap<u8, &'static str>> = LazyLock::new(|| {
    EXTRA_INFO3_IMAGE_STABILIZATION_DATA.iter().cloned().collect()
});
...
/// Lookup table (lazy-initialized)
pub static EXTRA_INFO3_CAMERA_ORIENTATION: LazyLock<HashMap<u8, &'static str>> = LazyLock::new(|| {
    EXTRA_INFO3_CAMERA_ORIENTATION_DATA.iter().cloned().collect()
});
