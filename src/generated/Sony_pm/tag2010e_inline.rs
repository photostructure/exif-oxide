...
/// Raw data (7 entries)
static TAG2010E_RELEASE_MODE3_DATA: &[(u8, &'static str)] = &[
    (0, "Normal"),
    (1, "Continuous"),
    (2, "Bracketing"),
    (4, "Continuous - Burst"),
...
pub fn lookup_tag2010e__release_mode3(key: u8) -> Option<&'static str> {
    TAG2010E_RELEASE_MODE3.get(&key).copied()
}

/// Raw data (23 entries)
static TAG2010E_RELEASE_MODE2_DATA: &[(u8, &'static str)] = &[
    (0, "Normal"),
    (1, "Continuous"),
...
pub fn lookup_tag2010e__release_mode2(key: u8) -> Option<&'static str> {
    TAG2010E_RELEASE_MODE2.get(&key).copied()
}
...
pub fn lookup_tag2010e__self_timer(key: u8) -> Option<&'static str> {
    TAG2010E_SELF_TIMER.get(&key).copied()
}

/// Raw data (6 entries)
static TAG2010E_FLASH_MODE_DATA: &[(u8, &'static str)] = &[
    (0, "Autoflash"),
    (1, "Fill-flash"),
    (2, "Flash Off"),
    (3, "Slow Sync"),
...
pub fn lookup_tag2010e__flash_mode(key: u8) -> Option<&'static str> {
    TAG2010E_FLASH_MODE.get(&key).copied()
}

/// Raw data (8 entries)
static TAG2010E_DYNAMIC_RANGE_OPTIMIZER_DATA: &[(u8, &'static str)] = &[
    (0, "Off"),
    (1, "Auto"),
    (3, "Lv1"),
    (4, "Lv2"),
...
pub fn lookup_tag2010e__dynamic_range_optimizer(key: u8) -> Option<&'static str> {
    TAG2010E_DYNAMIC_RANGE_OPTIMIZER.get(&key).copied()
}

/// Raw data (8 entries)
static TAG2010E_H_D_R_SETTING_DATA: &[(u8, &'static str)] = &[
    (0, "Off"),
    (1, "HDR Auto"),
    (3, "HDR 1 EV"),
    (5, "HDR 2 EV"),
...
pub fn lookup_tag2010e__h_d_r_setting(key: u8) -> Option<&'static str> {
    TAG2010E_H_D_R_SETTING.get(&key).copied()
}

/// Raw data (14 entries)
static TAG2010E_PICTURE_EFFECT2_DATA: &[(u8, &'static str)] = &[
    (0, "Off"),
    (1, "Toy Camera"),
    (2, "Pop Color"),
    (3, "Posterization"),
...
pub fn lookup_tag2010e__picture_effect2(key: u8) -> Option<&'static str> {
    TAG2010E_PICTURE_EFFECT2.get(&key).copied()
}
...
pub fn lookup_tag2010e__quality2(key: u8) -> Option<&'static str> {
    TAG2010E_QUALITY2.get(&key).copied()
}

/// Raw data (5 entries)
static TAG2010E_METERING_MODE_DATA: &[(u8, &'static str)] = &[
    (0, "Multi-segment"),
...
pub fn lookup_tag2010e__metering_mode(key: u8) -> Option<&'static str> {
    TAG2010E_METERING_MODE.get(&key).copied()
}

/// Raw data (33 entries)
static TAG2010E_EXPOSURE_PROGRAM_DATA: &[(u8, &'static str)] = &[
    (0, "Program AE"),
...
pub fn lookup_tag2010e__exposure_program(key: u8) -> Option<&'static str> {
    TAG2010E_EXPOSURE_PROGRAM.get(&key).copied()
}
...
pub fn lookup_tag2010e__lens_format(key: u8) -> Option<&'static str> {
    TAG2010E_LENS_FORMAT.get(&key).copied()
}
...
pub fn lookup_tag2010e__lens_mount(key: u8) -> Option<&'static str> {
    TAG2010E_LENS_MOUNT.get(&key).copied()
}

/// Raw data (276 entries)
static TAG2010E_LENS_TYPE2_DATA: &[(&'static str, &'static str)] = &[
...
pub fn lookup_tag2010e__lens_type2(key: &str) -> Option<&'static str> {
    TAG2010E_LENS_TYPE2.get(key).copied()
}
...
pub fn lookup_tag2010e__distortion_corr_params_present(key: u8) -> Option<&'static str> {
    TAG2010E_DISTORTION_CORR_PARAMS_PRESENT.get(&key).copied()
}
...
pub fn lookup_tag2010e__distortion_corr_params_number(key: u8) -> Option<&'static str> {
    TAG2010E_DISTORTION_CORR_PARAMS_NUMBER.get(&key).copied()
}

/// Raw data (5 entries)
static TAG2010E_ASPECT_RATIO_DATA: &[(u8, &'static str)] = &[
    (0, "16:9"),
    (1, "4:3"),
    (2, "3:2"),
    (3, "1:1"),
...
pub fn lookup_tag2010e__aspect_ratio(key: u8) -> Option<&'static str> {
    TAG2010E_ASPECT_RATIO.get(&key).copied()
}

/// Raw data (5 entries)
static TAG2010E_ASPECT_RATIO_6792_DATA: &[(u8, &'static str)] = &[
    (0, "16:9"),
    (1, "4:3"),
    (2, "3:2"),
    (3, "1:1"),
...
pub fn lookup_tag2010e__aspect_ratio_6792(key: u8) -> Option<&'static str> {
    TAG2010E_ASPECT_RATIO_6792.get(&key).copied()
}

/// Raw data (23 entries)
static TAG2010E_RELEASE_MODE2_8_DATA: &[(u8, &'static str)] = &[
    (0, "Normal"),
    (1, "Continuous"),
    (2, "Continuous - Exposure Bracketing"),
    (3, "DRO or White Balance Bracketing"),
...
pub fn lookup_tag2010e__release_mode2_8(key: u8) -> Option<&'static str> {
    TAG2010E_RELEASE_MODE2_8.get(&key).copied()
}

/// Raw data (8 entries)
static TAG2010E_DYNAMIC_RANGE_OPTIMIZER_808_DATA: &[(u8, &'static str)] = &[
    (0, "Off"),
    (1, "Auto"),
    (3, "Lv1"),
    (4, "Lv2"),
...
pub fn lookup_tag2010e__dynamic_range_optimizer_808(key: u8) -> Option<&'static str> {
    TAG2010E_DYNAMIC_RANGE_OPTIMIZER_808.get(&key).copied()
}
