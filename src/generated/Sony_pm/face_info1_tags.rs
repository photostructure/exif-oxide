//! Generated tag table definitions from Sony::FaceInfo1
//!
...
/// Tag definitions for Sony::FaceInfo1 table
pub static SONY_FACEINFO1_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            0,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = SONY_FACEINFO1_TAGS.get(&tag_id_u16) {
