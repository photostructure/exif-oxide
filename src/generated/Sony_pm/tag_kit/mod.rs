...
//!
//! Generated from: Sony.pm table: AFInfo
//!
...
fn process_sony_afstatus19(data: &[u8], byte_order: ByteOrder) -> Result<Vec<(String, TagValue)>> {
    let mut tags = Vec::new();
    // AFStatusUpperFarLeft at offset 0
    if data.len() >= 2 {
        if let Ok(value) = read_int16s(&data[0..2], byte_order) {
            tags.push(("AFStatusUpperFarLeft".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatusLower-leftHorizontal at offset 10
    if data.len() >= 22 {
        if let Ok(value) = read_int16s(&data[20..22], byte_order) {
            tags.push((
    ...
    // AFStatusUpper-leftVertical at offset 12
    if data.len() >= 26 {
        if let Ok(value) = read_int16s(&data[24..26], byte_order) {
            tags.push((
    ...
    // AFStatusLeftVertical at offset 14
    if data.len() >= 30 {
        if let Ok(value) = read_int16s(&data[28..30], byte_order) {
            tags.push(("AFStatusLeftVertical".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatusLower-leftVertical at offset 16
    if data.len() >= 34 {
        if let Ok(value) = read_int16s(&data[32..34], byte_order) {
            tags.push((
    ...
    // AFStatusFarLeftVertical at offset 18
    if data.len() >= 38 {
        if let Ok(value) = read_int16s(&data[36..38], byte_order) {
            tags.push(("AFStatusFarLeftVertical".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatusUpper-leftHorizontal at offset 2
    if data.len() >= 6 {
        if let Ok(value) = read_int16s(&data[4..6], byte_order) {
            tags.push((
    ...
    // AFStatusTopHorizontal at offset 20
    if data.len() >= 42 {
        if let Ok(value) = read_int16s(&data[40..42], byte_order) {
            tags.push(("AFStatusTopHorizontal".to_string(), TagValue::I16(value)));
        }
    ...
    // AFStatusNearRight at offset 22
    if data.len() >= 46 {
        if let Ok(value) = read_int16s(&data[44..46], byte_order) {
            tags.push(("AFStatusNearRight".to_string(), TagValue::I16(value)));
        }
    ...
    // AFStatusCenterHorizontal at offset 24
    if data.len() >= 50 {
        if let Ok(value) = read_int16s(&data[48..50], byte_order) {
            tags.push(("AFStatusCenterHorizontal".to_string(), TagValue::I16(value)));
        }
    ...
    // AFStatusBottomHorizontal at offset 28
    if data.len() >= 58 {
        if let Ok(value) = read_int16s(&data[56..58], byte_order) {
            tags.push(("AFStatusBottomHorizontal".to_string(), TagValue::I16(value)));
        }
    ...
    // AFStatusTopVertical at offset 30
    if data.len() >= 62 {
        if let Ok(value) = read_int16s(&data[60..62], byte_order) {
            tags.push(("AFStatusTopVertical".to_string(), TagValue::I16(value)));
        }
    ...
    // AFStatusCenterVertical at offset 34
    if data.len() >= 70 {
        if let Ok(value) = read_int16s(&data[68..70], byte_order) {
            tags.push(("AFStatusCenterVertical".to_string(), TagValue::I16(value)));
        }
    ...
    // AFStatusLower-middle at offset 36
    if data.len() >= 74 {
        if let Ok(value) = read_int16s(&data[72..74], byte_order) {
            tags.push(("AFStatusLower-middle".to_string(), TagValue::I16(value)));
        }
    ...
    // AFStatusBottomVertical at offset 38
    if data.len() >= 78 {
        if let Ok(value) = read_int16s(&data[76..78], byte_order) {
            tags.push(("AFStatusBottomVertical".to_string(), TagValue::I16(value)));
        }
    ...
    // AFStatusFarLeftHorizontal at offset 4
    if data.len() >= 10 {
        if let Ok(value) = read_int16s(&data[8..10], byte_order) {
            tags.push((
    ...
    // AFStatusUpperFarRight at offset 40
    if data.len() >= 82 {
        if let Ok(value) = read_int16s(&data[80..82], byte_order) {
            tags.push(("AFStatusUpperFarRight".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatusUpper-rightHorizontal at offset 42
    if data.len() >= 86 {
        if let Ok(value) = read_int16s(&data[84..86], byte_order) {
            tags.push((
    ...
    // AFStatusFarRightHorizontal at offset 44
    if data.len() >= 90 {
        if let Ok(value) = read_int16s(&data[88..90], byte_order) {
            tags.push((
    ...
    // AFStatusRightHorizontal at offset 46
    if data.len() >= 94 {
        if let Ok(value) = read_int16s(&data[92..94], byte_order) {
            tags.push(("AFStatusRightHorizontal".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatusLowerFarRight at offset 48
    if data.len() >= 98 {
        if let Ok(value) = read_int16s(&data[96..98], byte_order) {
            tags.push(("AFStatusLowerFarRight".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatusLower-rightHorizontal at offset 50
    if data.len() >= 102 {
        if let Ok(value) = read_int16s(&data[100..102], byte_order) {
            tags.push((
    ...
    // AFStatusFarRightVertical at offset 52
    if data.len() >= 106 {
        if let Ok(value) = read_int16s(&data[104..106], byte_order) {
            tags.push(("AFStatusFarRightVertical".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatusUpper-rightVertical at offset 54
    if data.len() >= 110 {
        if let Ok(value) = read_int16s(&data[108..110], byte_order) {
            tags.push((
    ...
    // AFStatusRightVertical at offset 56
    if data.len() >= 114 {
        if let Ok(value) = read_int16s(&data[112..114], byte_order) {
            tags.push(("AFStatusRightVertical".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatusLower-rightVertical at offset 58
    if data.len() >= 118 {
        if let Ok(value) = read_int16s(&data[116..118], byte_order) {
            tags.push((
    ...
    // AFStatusLeftHorizontal at offset 6
    if data.len() >= 14 {
        if let Ok(value) = read_int16s(&data[12..14], byte_order) {
            tags.push(("AFStatusLeftHorizontal".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatusLowerFarLeft at offset 8
    if data.len() >= 18 {
        if let Ok(value) = read_int16s(&data[16..18], byte_order) {
            tags.push(("AFStatusLowerFarLeft".to_string(), TagValue::I16(value)));
        }
    }
...
fn process_sony_afstatus79(data: &[u8], byte_order: ByteOrder) -> Result<Vec<(String, TagValue)>> {
    let mut tags = Vec::new();
    // AFStatus_00_B4 at offset 0
    if data.len() >= 2 {
        if let Ok(value) = read_int16s(&data[0..2], byte_order) {
            tags.push(("AFStatus_00_B4".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_05_G4 at offset 10
    if data.len() >= 22 {
        if let Ok(value) = read_int16s(&data[20..22], byte_order) {
            tags.push(("AFStatus_05_G4".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_50_A6 at offset 100
    if data.len() >= 202 {
        if let Ok(value) = read_int16s(&data[200..202], byte_order) {
            tags.push(("AFStatus_50_A6".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_51_B6 at offset 102
    if data.len() >= 206 {
        if let Ok(value) = read_int16s(&data[204..206], byte_order) {
            tags.push(("AFStatus_51_B6".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_52_C6 at offset 104
    if data.len() >= 210 {
        if let Ok(value) = read_int16s(&data[208..210], byte_order) {
            tags.push(("AFStatus_52_C6".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_53_D6 at offset 106
    if data.len() >= 214 {
        if let Ok(value) = read_int16s(&data[212..214], byte_order) {
            tags.push(("AFStatus_53_D6".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_54_E6_Center at offset 108
    if data.len() >= 218 {
        if let Ok(value) = read_int16s(&data[216..218], byte_order) {
            tags.push(("AFStatus_54_E6_Center".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_55_F6 at offset 110
    if data.len() >= 222 {
        if let Ok(value) = read_int16s(&data[220..222], byte_order) {
            tags.push(("AFStatus_55_F6".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_56_G6 at offset 112
    if data.len() >= 226 {
        if let Ok(value) = read_int16s(&data[224..226], byte_order) {
            tags.push(("AFStatus_56_G6".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_57_H6 at offset 114
    if data.len() >= 230 {
        if let Ok(value) = read_int16s(&data[228..230], byte_order) {
            tags.push(("AFStatus_57_H6".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_58_I6 at offset 116
    if data.len() >= 234 {
        if let Ok(value) = read_int16s(&data[232..234], byte_order) {
            tags.push(("AFStatus_58_I6".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_59_A5 at offset 118
    if data.len() >= 238 {
        if let Ok(value) = read_int16s(&data[236..238], byte_order) {
            tags.push(("AFStatus_59_A5".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_06_H4 at offset 12
    if data.len() >= 26 {
        if let Ok(value) = read_int16s(&data[24..26], byte_order) {
            tags.push(("AFStatus_06_H4".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_60_B5 at offset 120
    if data.len() >= 242 {
        if let Ok(value) = read_int16s(&data[240..242], byte_order) {
            tags.push(("AFStatus_60_B5".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_61_C5 at offset 122
    if data.len() >= 246 {
        if let Ok(value) = read_int16s(&data[244..246], byte_order) {
            tags.push(("AFStatus_61_C5".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_62_D5 at offset 124
    if data.len() >= 250 {
        if let Ok(value) = read_int16s(&data[248..250], byte_order) {
            tags.push(("AFStatus_62_D5".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_63_E5 at offset 126
    if data.len() >= 254 {
        if let Ok(value) = read_int16s(&data[252..254], byte_order) {
            tags.push(("AFStatus_63_E5".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_64_F5 at offset 128
    if data.len() >= 258 {
        if let Ok(value) = read_int16s(&data[256..258], byte_order) {
            tags.push(("AFStatus_64_F5".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_65_G5 at offset 130
    if data.len() >= 262 {
        if let Ok(value) = read_int16s(&data[260..262], byte_order) {
            tags.push(("AFStatus_65_G5".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_66_H5 at offset 132
    if data.len() >= 266 {
        if let Ok(value) = read_int16s(&data[264..266], byte_order) {
            tags.push(("AFStatus_66_H5".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_67_I5 at offset 134
    if data.len() >= 270 {
        if let Ok(value) = read_int16s(&data[268..270], byte_order) {
            tags.push(("AFStatus_67_I5".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_68_C11 at offset 136
    if data.len() >= 274 {
        if let Ok(value) = read_int16s(&data[272..274], byte_order) {
            tags.push(("AFStatus_68_C11".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_69_D11 at offset 138
    if data.len() >= 278 {
        if let Ok(value) = read_int16s(&data[276..278], byte_order) {
            tags.push(("AFStatus_69_D11".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_07_B3 at offset 14
    if data.len() >= 30 {
        if let Ok(value) = read_int16s(&data[28..30], byte_order) {
            tags.push(("AFStatus_07_B3".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_70_E11 at offset 140
    if data.len() >= 282 {
        if let Ok(value) = read_int16s(&data[280..282], byte_order) {
            tags.push(("AFStatus_70_E11".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_71_F11 at offset 142
    if data.len() >= 286 {
        if let Ok(value) = read_int16s(&data[284..286], byte_order) {
            tags.push(("AFStatus_71_F11".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_72_G11 at offset 144
    if data.len() >= 290 {
        if let Ok(value) = read_int16s(&data[288..290], byte_order) {
            tags.push(("AFStatus_72_G11".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_73_B10 at offset 146
    if data.len() >= 294 {
        if let Ok(value) = read_int16s(&data[292..294], byte_order) {
            tags.push(("AFStatus_73_B10".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_74_C10 at offset 148
    if data.len() >= 298 {
        if let Ok(value) = read_int16s(&data[296..298], byte_order) {
            tags.push(("AFStatus_74_C10".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_75_D10 at offset 150
    if data.len() >= 302 {
        if let Ok(value) = read_int16s(&data[300..302], byte_order) {
            tags.push(("AFStatus_75_D10".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_76_E10 at offset 152
    if data.len() >= 306 {
        if let Ok(value) = read_int16s(&data[304..306], byte_order) {
            tags.push(("AFStatus_76_E10".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_77_F10 at offset 154
    if data.len() >= 310 {
        if let Ok(value) = read_int16s(&data[308..310], byte_order) {
            tags.push(("AFStatus_77_F10".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_78_G10 at offset 156
    if data.len() >= 314 {
        if let Ok(value) = read_int16s(&data[312..314], byte_order) {
            tags.push(("AFStatus_78_G10".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_79_H10 at offset 158
    if data.len() >= 318 {
        if let Ok(value) = read_int16s(&data[316..318], byte_order) {
            tags.push(("AFStatus_79_H10".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_08_C3 at offset 16
    if data.len() >= 34 {
        if let Ok(value) = read_int16s(&data[32..34], byte_order) {
            tags.push(("AFStatus_08_C3".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_80_B9 at offset 160
    if data.len() >= 322 {
        if let Ok(value) = read_int16s(&data[320..322], byte_order) {
            tags.push(("AFStatus_80_B9".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_81_C9 at offset 162
    if data.len() >= 326 {
        if let Ok(value) = read_int16s(&data[324..326], byte_order) {
            tags.push(("AFStatus_81_C9".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_82_D9 at offset 164
    if data.len() >= 330 {
        if let Ok(value) = read_int16s(&data[328..330], byte_order) {
            tags.push(("AFStatus_82_D9".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_83_E9 at offset 166
    if data.len() >= 334 {
        if let Ok(value) = read_int16s(&data[332..334], byte_order) {
            tags.push(("AFStatus_83_E9".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_84_F9 at offset 168
    if data.len() >= 338 {
        if let Ok(value) = read_int16s(&data[336..338], byte_order) {
            tags.push(("AFStatus_84_F9".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_85_G9 at offset 170
    if data.len() >= 342 {
        if let Ok(value) = read_int16s(&data[340..342], byte_order) {
            tags.push(("AFStatus_85_G9".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_86_H9 at offset 172
    if data.len() >= 346 {
        if let Ok(value) = read_int16s(&data[344..346], byte_order) {
            tags.push(("AFStatus_86_H9".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_87_B8 at offset 174
    if data.len() >= 350 {
        if let Ok(value) = read_int16s(&data[348..350], byte_order) {
            tags.push(("AFStatus_87_B8".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_88_C8 at offset 176
    if data.len() >= 354 {
        if let Ok(value) = read_int16s(&data[352..354], byte_order) {
            tags.push(("AFStatus_88_C8".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_89_D8 at offset 178
    if data.len() >= 358 {
        if let Ok(value) = read_int16s(&data[356..358], byte_order) {
            tags.push(("AFStatus_89_D8".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_09_D3 at offset 18
    if data.len() >= 38 {
        if let Ok(value) = read_int16s(&data[36..38], byte_order) {
            tags.push(("AFStatus_09_D3".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_90_E8 at offset 180
    if data.len() >= 362 {
        if let Ok(value) = read_int16s(&data[360..362], byte_order) {
            tags.push(("AFStatus_90_E8".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_91_F8 at offset 182
    if data.len() >= 366 {
        if let Ok(value) = read_int16s(&data[364..366], byte_order) {
            tags.push(("AFStatus_91_F8".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_92_G8 at offset 184
    if data.len() >= 370 {
        if let Ok(value) = read_int16s(&data[368..370], byte_order) {
            tags.push(("AFStatus_92_G8".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_93_H8 at offset 186
    if data.len() >= 374 {
        if let Ok(value) = read_int16s(&data[372..374], byte_order) {
            tags.push(("AFStatus_93_H8".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_94_E6_Center_F2-8 at offset 188
    if data.len() >= 378 {
        if let Ok(value) = read_int16s(&data[376..378], byte_order) {
            tags.push((
    ...
    // AFStatus_01_C4 at offset 2
    if data.len() >= 6 {
        if let Ok(value) = read_int16s(&data[4..6], byte_order) {
            tags.push(("AFStatus_01_C4".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_10_E3 at offset 20
    if data.len() >= 42 {
        if let Ok(value) = read_int16s(&data[40..42], byte_order) {
            tags.push(("AFStatus_10_E3".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_11_F3 at offset 22
    if data.len() >= 46 {
        if let Ok(value) = read_int16s(&data[44..46], byte_order) {
            tags.push(("AFStatus_11_F3".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_12_G3 at offset 24
    if data.len() >= 50 {
        if let Ok(value) = read_int16s(&data[48..50], byte_order) {
            tags.push(("AFStatus_12_G3".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_13_H3 at offset 26
    if data.len() >= 54 {
        if let Ok(value) = read_int16s(&data[52..54], byte_order) {
            tags.push(("AFStatus_13_H3".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_14_B2 at offset 28
    if data.len() >= 58 {
        if let Ok(value) = read_int16s(&data[56..58], byte_order) {
            tags.push(("AFStatus_14_B2".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_15_C2 at offset 30
    if data.len() >= 62 {
        if let Ok(value) = read_int16s(&data[60..62], byte_order) {
            tags.push(("AFStatus_15_C2".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_16_D2 at offset 32
    if data.len() >= 66 {
        if let Ok(value) = read_int16s(&data[64..66], byte_order) {
            tags.push(("AFStatus_16_D2".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_17_E2 at offset 34
    if data.len() >= 70 {
        if let Ok(value) = read_int16s(&data[68..70], byte_order) {
            tags.push(("AFStatus_17_E2".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_18_F2 at offset 36
    if data.len() >= 74 {
        if let Ok(value) = read_int16s(&data[72..74], byte_order) {
            tags.push(("AFStatus_18_F2".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_19_G2 at offset 38
    if data.len() >= 78 {
        if let Ok(value) = read_int16s(&data[76..78], byte_order) {
            tags.push(("AFStatus_19_G2".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_02_D4 at offset 4
    if data.len() >= 10 {
        if let Ok(value) = read_int16s(&data[8..10], byte_order) {
            tags.push(("AFStatus_02_D4".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_20_H2 at offset 40
    if data.len() >= 82 {
        if let Ok(value) = read_int16s(&data[80..82], byte_order) {
            tags.push(("AFStatus_20_H2".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_21_C1 at offset 42
    if data.len() >= 86 {
        if let Ok(value) = read_int16s(&data[84..86], byte_order) {
            tags.push(("AFStatus_21_C1".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_22_D1 at offset 44
    if data.len() >= 90 {
        if let Ok(value) = read_int16s(&data[88..90], byte_order) {
            tags.push(("AFStatus_22_D1".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_23_E1 at offset 46
    if data.len() >= 94 {
        if let Ok(value) = read_int16s(&data[92..94], byte_order) {
            tags.push(("AFStatus_23_E1".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_24_F1 at offset 48
    if data.len() >= 98 {
        if let Ok(value) = read_int16s(&data[96..98], byte_order) {
            tags.push(("AFStatus_24_F1".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_25_G1 at offset 50
    if data.len() >= 102 {
        if let Ok(value) = read_int16s(&data[100..102], byte_order) {
            tags.push(("AFStatus_25_G1".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_26_A7_Vertical at offset 52
    if data.len() >= 106 {
        if let Ok(value) = read_int16s(&data[104..106], byte_order) {
            tags.push(("AFStatus_26_A7_Vertical".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_27_A6_Vertical at offset 54
    if data.len() >= 110 {
        if let Ok(value) = read_int16s(&data[108..110], byte_order) {
            tags.push(("AFStatus_27_A6_Vertical".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_28_A5_Vertical at offset 56
    if data.len() >= 114 {
        if let Ok(value) = read_int16s(&data[112..114], byte_order) {
            tags.push(("AFStatus_28_A5_Vertical".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_29_C7_Vertical at offset 58
    if data.len() >= 118 {
        if let Ok(value) = read_int16s(&data[116..118], byte_order) {
            tags.push(("AFStatus_29_C7_Vertical".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_03_E4 at offset 6
    if data.len() >= 14 {
        if let Ok(value) = read_int16s(&data[12..14], byte_order) {
            tags.push(("AFStatus_03_E4".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_30_C6_Vertical at offset 60
    if data.len() >= 122 {
        if let Ok(value) = read_int16s(&data[120..122], byte_order) {
            tags.push(("AFStatus_30_C6_Vertical".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_31_C5_Vertical at offset 62
    if data.len() >= 126 {
        if let Ok(value) = read_int16s(&data[124..126], byte_order) {
            tags.push(("AFStatus_31_C5_Vertical".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_32_E7_Vertical at offset 64
    if data.len() >= 130 {
        if let Ok(value) = read_int16s(&data[128..130], byte_order) {
            tags.push(("AFStatus_32_E7_Vertical".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_33_E6_Center_Vertical at offset 66
    if data.len() >= 134 {
        if let Ok(value) = read_int16s(&data[132..134], byte_order) {
            tags.push((
    ...
    // AFStatus_34_E5_Vertical at offset 68
    if data.len() >= 138 {
        if let Ok(value) = read_int16s(&data[136..138], byte_order) {
            tags.push(("AFStatus_34_E5_Vertical".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_35_G7_Vertical at offset 70
    if data.len() >= 142 {
        if let Ok(value) = read_int16s(&data[140..142], byte_order) {
            tags.push(("AFStatus_35_G7_Vertical".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_36_G6_Vertical at offset 72
    if data.len() >= 146 {
        if let Ok(value) = read_int16s(&data[144..146], byte_order) {
            tags.push(("AFStatus_36_G6_Vertical".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_37_G5_Vertical at offset 74
    if data.len() >= 150 {
        if let Ok(value) = read_int16s(&data[148..150], byte_order) {
            tags.push(("AFStatus_37_G5_Vertical".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_38_I7_Vertical at offset 76
    if data.len() >= 154 {
        if let Ok(value) = read_int16s(&data[152..154], byte_order) {
            tags.push(("AFStatus_38_I7_Vertical".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_39_I6_Vertical at offset 78
    if data.len() >= 158 {
        if let Ok(value) = read_int16s(&data[156..158], byte_order) {
            tags.push(("AFStatus_39_I6_Vertical".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_04_F4 at offset 8
    if data.len() >= 18 {
        if let Ok(value) = read_int16s(&data[16..18], byte_order) {
            tags.push(("AFStatus_04_F4".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_40_I5_Vertical at offset 80
    if data.len() >= 162 {
        if let Ok(value) = read_int16s(&data[160..162], byte_order) {
            tags.push(("AFStatus_40_I5_Vertical".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_41_A7 at offset 82
    if data.len() >= 166 {
        if let Ok(value) = read_int16s(&data[164..166], byte_order) {
            tags.push(("AFStatus_41_A7".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_42_B7 at offset 84
    if data.len() >= 170 {
        if let Ok(value) = read_int16s(&data[168..170], byte_order) {
            tags.push(("AFStatus_42_B7".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_43_C7 at offset 86
    if data.len() >= 174 {
        if let Ok(value) = read_int16s(&data[172..174], byte_order) {
            tags.push(("AFStatus_43_C7".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_44_D7 at offset 88
    if data.len() >= 178 {
        if let Ok(value) = read_int16s(&data[176..178], byte_order) {
            tags.push(("AFStatus_44_D7".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_45_E7 at offset 90
    if data.len() >= 182 {
        if let Ok(value) = read_int16s(&data[180..182], byte_order) {
            tags.push(("AFStatus_45_E7".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_46_F7 at offset 92
    if data.len() >= 186 {
        if let Ok(value) = read_int16s(&data[184..186], byte_order) {
            tags.push(("AFStatus_46_F7".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_47_G7 at offset 94
    if data.len() >= 190 {
        if let Ok(value) = read_int16s(&data[188..190], byte_order) {
            tags.push(("AFStatus_47_G7".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_48_H7 at offset 96
    if data.len() >= 194 {
        if let Ok(value) = read_int16s(&data[192..194], byte_order) {
            tags.push(("AFStatus_48_H7".to_string(), TagValue::I16(value)));
        }
    }

    // AFStatus_49_I7 at offset 98
    if data.len() >= 198 {
        if let Ok(value) = read_int16s(&data[196..198], byte_order) {
            tags.push(("AFStatus_49_I7".to_string(), TagValue::I16(value)));
        }
    }
...
fn process_sony_isoinfo(data: &[u8], byte_order: ByteOrder) -> Result<Vec<(String, TagValue)>> {
    let mut tags = Vec::new();
    // ISOSetting at offset 0

    // ISOAutoMin at offset 2

    // ISOAutoMax at offset 4
...
fn process_sony_sr2dataifd(data: &[u8], _byte_order: ByteOrder) -> Result<Vec<(String, TagValue)>> {
...
pub fn process_tag_0x2_subdirectory(
    ...
    // Model condition: $$self{Model} !~ /^DSLR-(A450|A500|A550)$/
    if let Some(model) = &model {
        ...
        if evaluator
            ...
            .unwrap_or(false)
        {
            debug!("Model condition matched: $$self{{Model}} !~ /^DSLR-(A450|A500|A550)$/ for sony_faceinfo");
            return process_sony_faceinfo(data, byte_order);
        }
    }
    // Model condition: $$self{Model} =~ /^DSLR-(A450|A500|A550)$/
    if let Some(model) = &model {
        ...
        if evaluator
            ...
            .unwrap_or(false)
        {
            debug!("Model condition matched: $$self{{Model}} =~ /^DSLR-(A450|A500|A550)$/ for sony_faceinfoa");
            return process_sony_faceinfoa(data, byte_order);
        }
    }
    Ok(vec![])
}
...
pub fn process_tag_0x11_subdirectory(
    ...
    // Runtime condition not yet supported: $$self{AFType} == 1
    // Would dispatch to: Image::ExifTool::Sony::AFStatus15
    // Runtime condition not yet supported: $$self{AFType} == 2
    // Would dispatch to: Image::ExifTool::Sony::AFStatus19
    Ok(vec![])
}
...
pub fn process_tag_0x23_subdirectory(
    ...
    // Model condition: $$self{Model} =~ /^(SLT-|DSLR-A(560|580))\\b/
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator
            ...
            .unwrap_or(false)
        {
            debug!("Model condition matched: $$self{{Model}} =~ /^(SLT-|DSLR-A(560|580))\\b/ for sony_afstatus15");
            return process_sony_afstatus15(data, byte_order);
        }
    }
    Ok(vec![])
}
...
pub fn process_tag_0x7d_subdirectory(
    ...
    // Runtime condition not yet supported: $$self{AFType} == 3
    // Would dispatch to: Image::ExifTool::Sony::AFStatus79
    Ok(vec![])
}
...
pub fn process_tag_0x116_subdirectory(
    ...
    // Model condition: $$self{Model} =~ /^DSLR-A(850|900)\\b/
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator
            .evaluate_context_condition(
                &processor_context,
                "$$self{Model} =~ /^DSLR-A(850|900)\\b/",
            )
            .unwrap_or(false)
        {
            debug!("Model condition matched: $$self{{Model}} =~ /^DSLR-A(850|900)\\b/ for sony_extrainfo");
            return process_sony_extrainfo(data, byte_order);
        }
    }
    // Model condition: $$self{Model} =~ /^DSLR-A(230|290|330|380|390)\\b/
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator
            .evaluate_context_condition(
                &processor_context,
                "$$self{Model} =~ /^DSLR-A(230|290|330|380|390)\\b/",
            )
            .unwrap_or(false)
        {
            debug!("Model condition matched: $$self{{Model}} =~ /^DSLR-A(230|290|330|380|390)\\b/ for sony_extrainfo2");
            return process_sony_extrainfo2(data, byte_order);
        }
    }
    Ok(vec![])
}
...
pub fn process_tag_0x388_subdirectory(
    ...
    // Model condition: $$self{Model} !~ /^(ILCA-99M2|ILCE-6500|DSC-(RX0|RX100M5))/
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator
            ...
            .unwrap_or(false)
        {
            debug!("Model condition matched: $$self{{Model}} !~ /^(ILCA-99M2|ILCE-6500|DSC-(RX0|RX100M5))/ for sony_meterinfo");
            return process_sony_meterinfo(data, byte_order);
        }
    }
    Ok(vec![])
}
...
pub fn process_tag_0x3e2_subdirectory(
    data: &[u8],
    byte_order: ByteOrder,
    model: Option<&str>,
) -> Result<Vec<(String, TagValue)>> {
    ...
    let count = data.len() / 2;
    debug!(
        "process_tag_0x3e2_subdirectory called with {} bytes, count={}",
        data.len(),
        count
    );

    // Runtime condition not yet supported: $$self{Ver9401} == 181
    // Would dispatch to: Image::ExifTool::Sony::ISOInfo
    Ok(vec![])
}

pub fn process_tag_0x3f4_subdirectory(
    data: &[u8],
    byte_order: ByteOrder,
    model: Option<&str>,
) -> Result<Vec<(String, TagValue)>> {
    ...
    let count = data.len() / 2;
    debug!(
        "process_tag_0x3f4_subdirectory called with {} bytes, count={}",
        data.len(),
        count
    );

    // Runtime condition not yet supported: $$self{Ver9401} =~ /^(185|186)/
    // Would dispatch to: Image::ExifTool::Sony::ISOInfo
    Ok(vec![])
}
...
pub fn process_tag_0x44e_subdirectory(
    data: &[u8],
    byte_order: ByteOrder,
    model: Option<&str>,
) -> Result<Vec<(String, TagValue)>> {
    ...
    let count = data.len() / 2;
    debug!(
        "process_tag_0x44e_subdirectory called with {} bytes, count={}",
        data.len(),
        count
    );

    // Runtime condition not yet supported: $$self{Ver9401} == 178
    // Would dispatch to: Image::ExifTool::Sony::ISOInfo
    Ok(vec![])
}
...
pub fn process_tag_0x498_subdirectory(
    data: &[u8],
    byte_order: ByteOrder,
    model: Option<&str>,
) -> Result<Vec<(String, TagValue)>> {
    ...
    let count = data.len() / 2;
    debug!(
        "process_tag_0x498_subdirectory called with {} bytes, count={}",
        data.len(),
        count
    );

    // Runtime condition not yet supported: $$self{Ver9401} == 148
    // Would dispatch to: Image::ExifTool::Sony::ISOInfo
    Ok(vec![])
}

pub fn process_tag_0x49d_subdirectory(
    data: &[u8],
    byte_order: ByteOrder,
    model: Option<&str>,
) -> Result<Vec<(String, TagValue)>> {
    ...
    let count = data.len() / 2;
    debug!(
        "process_tag_0x49d_subdirectory called with {} bytes, count={}",
        data.len(),
        count
    );

    // Runtime condition not yet supported: $$self{Ver9401} == 167 and $$self{Software} !~ /^ILCE-7M4 (v2|v3)/
    // Would dispatch to: Image::ExifTool::Sony::ISOInfo
    Ok(vec![])
}

pub fn process_tag_0x49e_subdirectory(
    data: &[u8],
    byte_order: ByteOrder,
    model: Option<&str>,
) -> Result<Vec<(String, TagValue)>> {
    ...
    let count = data.len() / 2;
    debug!(
        "process_tag_0x49e_subdirectory called with {} bytes, count={}",
        data.len(),
        count
    );
...
pub fn process_tag_0x4a1_subdirectory(
    data: &[u8],
    byte_order: ByteOrder,
    model: Option<&str>,
) -> Result<Vec<(String, TagValue)>> {
    ...
    let count = data.len() / 2;
    debug!(
        "process_tag_0x4a1_subdirectory called with {} bytes, count={}",
        data.len(),
        count
    );

    // Runtime condition not yet supported: $$self{Ver9401} =~ /^(160|164)/ and $$self{Software} !~ /^ILCE-1 v2/
    // Would dispatch to: Image::ExifTool::Sony::ISOInfo
    Ok(vec![])
}

pub fn process_tag_0x4a2_subdirectory(
    data: &[u8],
    byte_order: ByteOrder,
    model: Option<&str>,
) -> Result<Vec<(String, TagValue)>> {
    ...
    let count = data.len() / 2;
    debug!(
        "process_tag_0x4a2_subdirectory called with {} bytes, count={}",
        data.len(),
        count
    );

    // Model condition: ($$self{Ver9401} =~ /^(152|154|155)/ and $$self{Model} !~ /^ZV-1M2/) or ($$self{Ver9401} == 164 and $$self{Software} =~ /^ILCE-1 v2/)
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator.evaluate_context_condition(&processor_context, "($$self{Ver9401} =~ /^(152|154|155)/ and $$self{Model} !~ /^ZV-1M2/) or ($$self{Ver9401} == 164 and $$self{Software} =~ /^ILCE-1 v2/)").unwrap_or(false) {
            debug!("Model condition matched: ($$self{{Ver9401}} =~ /^(152|154|155)/ and $$self{{Model}} !~ /^ZV-1M2/) or ($$self{{Ver9401}} == 164 and $$self{{Software}} =~ /^ILCE-1 v2/) for sony_isoinfo");
            return process_sony_isoinfo(data, byte_order);
        }
    }
    Ok(vec![])
}
...
pub fn process_tag_0x4ba_subdirectory(
    data: &[u8],
    byte_order: ByteOrder,
    model: Option<&str>,
) -> Result<Vec<(String, TagValue)>> {
    ...
    let count = data.len() / 2;
    debug!(
        "process_tag_0x4ba_subdirectory called with {} bytes, count={}",
        data.len(),
        count
    );

    // Model condition: $$self{Ver9401} == 155 and $$self{Model} =~ /^ZV-1M2/
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator
            .evaluate_context_condition(
                &processor_context,
                "$$self{Ver9401} == 155 and $$self{Model} =~ /^ZV-1M2/",
            )
            .unwrap_or(false)
        {
            debug!("Model condition matched: $$self{{Ver9401}} == 155 and $$self{{Model}} =~ /^ZV-1M2/ for sony_isoinfo");
            return process_sony_isoinfo(data, byte_order);
        }
    }
    Ok(vec![])
...
pub fn process_tag_0x59d_subdirectory(
    data: &[u8],
    byte_order: ByteOrder,
    model: Option<&str>,
) -> Result<Vec<(String, TagValue)>> {
    ...
    let count = data.len() / 2;
    debug!(
        "process_tag_0x59d_subdirectory called with {} bytes, count={}",
        data.len(),
        count
    );

    // Runtime condition not yet supported: $$self{Ver9401} =~ /^(144|146)/
    // Would dispatch to: Image::ExifTool::Sony::ISOInfo
    Ok(vec![])
}

pub fn process_tag_0x634_subdirectory(
    data: &[u8],
    byte_order: ByteOrder,
    model: Option<&str>,
) -> Result<Vec<(String, TagValue)>> {
    ...
    let count = data.len() / 2;
    debug!(
        "process_tag_0x634_subdirectory called with {} bytes, count={}",
        data.len(),
        count
    );

    // Runtime condition not yet supported: $$self{Ver9401} == 68
    // Would dispatch to: Image::ExifTool::Sony::ISOInfo
    Ok(vec![])
}

pub fn process_tag_0x636_subdirectory(
    data: &[u8],
    byte_order: ByteOrder,
    model: Option<&str>,
) -> Result<Vec<(String, TagValue)>> {
    ...
    let count = data.len() / 2;
    debug!(
        "process_tag_0x636_subdirectory called with {} bytes, count={}",
        data.len(),
        count
    );

    // Runtime condition not yet supported: $$self{Ver9401} =~ /^(73|74)/
    // Would dispatch to: Image::ExifTool::Sony::ISOInfo
    Ok(vec![])
}

pub fn process_tag_0x64c_subdirectory(
    data: &[u8],
    byte_order: ByteOrder,
    model: Option<&str>,
) -> Result<Vec<(String, TagValue)>> {
    ...
    let count = data.len() / 2;
    debug!(
        "process_tag_0x64c_subdirectory called with {} bytes, count={}",
        data.len(),
        count
    );

    // Runtime condition not yet supported: $$self{Ver9401} == 78
    // Would dispatch to: Image::ExifTool::Sony::ISOInfo
    Ok(vec![])
}

pub fn process_tag_0x653_subdirectory(
    data: &[u8],
    byte_order: ByteOrder,
    model: Option<&str>,
) -> Result<Vec<(String, TagValue)>> {
    ...
    let count = data.len() / 2;
    debug!(
        "process_tag_0x653_subdirectory called with {} bytes, count={}",
        data.len(),
        count
    );

    // Runtime condition not yet supported: $$self{Ver9401} == 90
    // Would dispatch to: Image::ExifTool::Sony::ISOInfo
    Ok(vec![])
}

pub fn process_tag_0x678_subdirectory(
    data: &[u8],
    byte_order: ByteOrder,
    model: Option<&str>,
) -> Result<Vec<(String, TagValue)>> {
    ...
    let count = data.len() / 2;
    debug!(
        "process_tag_0x678_subdirectory called with {} bytes, count={}",
        data.len(),
        count
    );

    // Runtime condition not yet supported: $$self{Ver9401} =~ /^(93|94)/
    // Would dispatch to: Image::ExifTool::Sony::ISOInfo
    Ok(vec![])
}

pub fn process_tag_0x6b8_subdirectory(
    data: &[u8],
    byte_order: ByteOrder,
    model: Option<&str>,
) -> Result<Vec<(String, TagValue)>> {
    ...
    let count = data.len() / 2;
    debug!(
        "process_tag_0x6b8_subdirectory called with {} bytes, count={}",
        data.len(),
        count
    );

    // Runtime condition not yet supported: $$self{Ver9401} =~ /^(100|103)/
    // Would dispatch to: Image::ExifTool::Sony::ISOInfo
    Ok(vec![])
}

pub fn process_tag_0x6de_subdirectory(
    data: &[u8],
    byte_order: ByteOrder,
    model: Option<&str>,
) -> Result<Vec<(String, TagValue)>> {
    ...
    let count = data.len() / 2;
    debug!(
        "process_tag_0x6de_subdirectory called with {} bytes, count={}",
        data.len(),
        count
    );

    // Runtime condition not yet supported: $$self{Ver9401} =~ /^(124|125)/
    // Would dispatch to: Image::ExifTool::Sony::ISOInfo
    Ok(vec![])
}

pub fn process_tag_0x6e7_subdirectory(
    data: &[u8],
    byte_order: ByteOrder,
    model: Option<&str>,
) -> Result<Vec<(String, TagValue)>> {
    ...
    let count = data.len() / 2;
    debug!(
        "process_tag_0x6e7_subdirectory called with {} bytes, count={}",
        data.len(),
        count
    );

    // Runtime condition not yet supported: $$self{Ver9401} =~ /^(127|128|130)/
    // Would dispatch to: Image::ExifTool::Sony::ISOInfo
    Ok(vec![])
}
...
pub fn process_tag_0x2010_subdirectory(
    ...
    // Model condition: $$self{Model} =~ /^NEX-5N$/
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator
            .evaluate_context_condition(&processor_context, "$$self{Model} =~ /^NEX-5N$/")
            .unwrap_or(false)
        {
            debug!("Model condition matched: $$self{{Model}} =~ /^NEX-5N$/ for sony_tag2010a");
            return process_sony_tag2010a(data, byte_order);
        }
    }
    // Model condition: $$self{Model} =~ /^(SLT-A(65|77)V?|NEX-(7|VG20E)|Lunar)$/
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator
            ...
            .unwrap_or(false)
        {
            debug!("Model condition matched: $$self{{Model}} =~ /^(SLT-A(65|77)V?|NEX-(7|VG20E)|Lunar)$/ for sony_tag2010b");
            return process_sony_tag2010b(data, byte_order);
        }
    }
    // Model condition: $$self{Model} =~ /^(SLT-A(37|57)|NEX-F3)$/
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator
            ...
            .unwrap_or(false)
        {
            debug!("Model condition matched: $$self{{Model}} =~ /^(SLT-A(37|57)|NEX-F3)$/ for sony_tag2010c");
            return process_sony_tag2010c(data, byte_order);
        }
    }
    // Model condition: $$self{Model} =~ /^(DSC-(HX10V|HX20V|HX30V|HX200V|TX66|TX200V|TX300V|WX50|WX70|WX100|WX150))$/ and not $$self{Panorama}
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator.evaluate_context_condition(&processor_context, "$$self{Model} =~ /^(DSC-(HX10V|HX20V|HX30V|HX200V|TX66|TX200V|TX300V|WX50|WX70|WX100|WX150))$/ and not $$self{Panorama}").unwrap_or(false) {
            debug!("Model condition matched: $$self{{Model}} =~ /^(DSC-(HX10V|HX20V|HX30V|HX200V|TX66|TX200V|TX300V|WX50|WX70|WX100|WX150))$/ and not $$self{{Panorama}} for sony_tag2010d");
            return process_sony_tag2010d(data, byte_order);
        }
    }
    // Model condition: $$self{Model} =~ /^(SLT-A99V?|HV|SLT-A58|ILCE-(3000|3500)|NEX-(3N|5R|5T|6|VG900|VG30E)|DSC-(RX100|RX1|RX1R)|Stellar)$/ or ($$self{Model} =~ /^(DSC-(HX300|HX50|HX50V|TX30|WX60|WX80|WX200|WX300))$/ and not $$self{Panorama})
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator.evaluate_context_condition(&processor_context, "$$self{Model} =~ /^(SLT-A99V?|HV|SLT-A58|ILCE-(3000|3500)|NEX-(3N|5R|5T|6|VG900|VG30E)|DSC-(RX100|RX1|RX1R)|Stellar)$/ or ($$self{Model} =~ /^(DSC-(HX300|HX50|HX50V|TX30|WX60|WX80|WX200|WX300))$/ and not $$self{Panorama})").unwrap_or(false) {
            debug!("Model condition matched: $$self{{Model}} =~ /^(SLT-A99V?|HV|SLT-A58|ILCE-(3000|3500)|NEX-(3N|5R|5T|6|VG900|VG30E)|DSC-(RX100|RX1|RX1R)|Stellar)$/ or ($$self{{Model}} =~ /^(DSC-(HX300|HX50|HX50V|TX30|WX60|WX80|WX200|WX300))$/ and not $$self{{Panorama}}) for sony_tag2010e");
            return process_sony_tag2010e(data, byte_order);
        }
    }
    // Model condition: $$self{Model} =~ /^(DSC-(RX100M2|QX10|QX100))$/
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator
            ...
            .unwrap_or(false)
        {
            debug!("Model condition matched: $$self{{Model}} =~ /^(DSC-(RX100M2|QX10|QX100))$/ for sony_tag2010f");
            return process_sony_tag2010f(data, byte_order);
        }
    }
    // Model condition: $$self{Model} =~ /^(DSC-(QX30|RX10|RX100M3|HX60V|HX350|HX400V|WX220|WX350)|ILCE-(7(R|S|M2)?|[56]000|5100|QX1)|ILCA-(68|77M2))\\b/
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator.evaluate_context_condition(&processor_context, "$$self{Model} =~ /^(DSC-(QX30|RX10|RX100M3|HX60V|HX350|HX400V|WX220|WX350)|ILCE-(7(R|S|M2)?|[56]000|5100|QX1)|ILCA-(68|77M2))\\b/").unwrap_or(false) {
            debug!("Model condition matched: $$self{{Model}} =~ /^(DSC-(QX30|RX10|RX100M3|HX60V|HX350|HX400V|WX220|WX350)|ILCE-(7(R|S|M2)?|[56]000|5100|QX1)|ILCA-(68|77M2))\\b/ for sony_tag2010g");
            return process_sony_tag2010g(data, byte_order);
        }
    }
    // Model condition: $$self{Model} =~ /^(DSC-(RX0|RX1RM2|RX10M2|RX10M3|RX100M4|RX100M5|HX80|HX90V?|WX500)|ILCE-(6300|6500|7RM2|7SM2)|ILCA-99M2)\\b/
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator.evaluate_context_condition(&processor_context, "$$self{Model} =~ /^(DSC-(RX0|RX1RM2|RX10M2|RX10M3|RX100M4|RX100M5|HX80|HX90V?|WX500)|ILCE-(6300|6500|7RM2|7SM2)|ILCA-99M2)\\b/").unwrap_or(false) {
            debug!("Model condition matched: $$self{{Model}} =~ /^(DSC-(RX0|RX1RM2|RX10M2|RX10M3|RX100M4|RX100M5|HX80|HX90V?|WX500)|ILCE-(6300|6500|7RM2|7SM2)|ILCA-99M2)\\b/ for sony_tag2010h");
            return process_sony_tag2010h(data, byte_order);
        }
    }
    // Model condition: $$self{Model} =~ /^(ILCE-(6100|6400|6600|7C|7M3|7RM3A?|7RM4A?|9|9M2)|DSC-(RX10M4|RX100M6|RX100M5A|RX100M7|HX95|HX99|RX0M2)|ZV-(1F?|1M2|E10))\\b/
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator.evaluate_context_condition(&processor_context, "$$self{Model} =~ /^(ILCE-(6100|6400|6600|7C|7M3|7RM3A?|7RM4A?|9|9M2)|DSC-(RX10M4|RX100M6|RX100M5A|RX100M7|HX95|HX99|RX0M2)|ZV-(1F?|1M2|E10))\\b/").unwrap_or(false) {
            debug!("Model condition matched: $$self{{Model}} =~ /^(ILCE-(6100|6400|6600|7C|7M3|7RM3A?|7RM4A?|9|9M2)|DSC-(RX10M4|RX100M6|RX100M5A|RX100M7|HX95|HX99|RX0M2)|ZV-(1F?|1M2|E10))\\b/ for sony_tag2010i");
            return process_sony_tag2010i(data, byte_order);
        }
    }
    Ok(vec![])
}
...
pub fn process_tag_0x7240_subdirectory(
    ...
    // Would dispatch to: Image::ExifTool::SonyIDC::Main
    Ok(vec![])
}
...
pub fn process_tag_0x7250_subdirectory(
    ...
    // Runtime condition not yet supported: $$valPt !~ /^\\0\\0\\0\\0/
    // Would dispatch to: Image::ExifTool::MinoltaRaw::Main
    Ok(vec![])
}

pub fn process_tag_0x74c0_subdirectory(
    data: &[u8],
    byte_order: ByteOrder,
    model: Option<&str>,
) -> Result<Vec<(String, TagValue)>> {
    ...
    let count = data.len() / 2;
    debug!(
        "process_tag_0x74c0_subdirectory called with {} bytes, count={}",
        data.len(),
        count
    );

    // Single unconditional subdirectory
    process_sony_sr2dataifd(data, byte_order)
}
...
pub fn process_tag_0x9050_subdirectory(
    ...
    // Model condition: $$self{Model} !~ /^(DSC-|Stellar|ILCE-(1|6100|6300|6400|6500|6600|6700|7C|7M3|7M4|7RM2|7RM3A?|7RM4A?|7RM5|7SM2|7SM3|9|9M2)|ILCA-99M2|ILME-FX3|ZV-)/
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator.evaluate_context_condition(&processor_context, "$$self{Model} !~ /^(DSC-|Stellar|ILCE-(1|6100|6300|6400|6500|6600|6700|7C|7M3|7M4|7RM2|7RM3A?|7RM4A?|7RM5|7SM2|7SM3|9|9M2)|ILCA-99M2|ILME-FX3|ZV-)/").unwrap_or(false) {
            debug!("Model condition matched: $$self{{Model}} !~ /^(DSC-|Stellar|ILCE-(1|6100|6300|6400|6500|6600|6700|7C|7M3|7M4|7RM2|7RM3A?|7RM4A?|7RM5|7SM2|7SM3|9|9M2)|ILCA-99M2|ILME-FX3|ZV-)/ for sony_tag9050a");
            return process_sony_tag9050a(data, byte_order);
        }
    }
    // Model condition: $$self{Model} =~ /^(ILCE-(6100|6300|6400|6500|6600|7C|7M3|7RM2|7RM3A?|7RM4A?|7SM2|9|9M2)|ILCA-99M2|ZV-E10)\\b/
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator.evaluate_context_condition(&processor_context, "$$self{Model} =~ /^(ILCE-(6100|6300|6400|6500|6600|7C|7M3|7RM2|7RM3A?|7RM4A?|7SM2|9|9M2)|ILCA-99M2|ZV-E10)\\b/").unwrap_or(false) {
            debug!("Model condition matched: $$self{{Model}} =~ /^(ILCE-(6100|6300|6400|6500|6600|7C|7M3|7RM2|7RM3A?|7RM4A?|7SM2|9|9M2)|ILCA-99M2|ZV-E10)\\b/ for sony_tag9050b");
            return process_sony_tag9050b(data, byte_order);
        }
    }
    // Model condition: $$self{Model} =~ /^(ILCE-(1\\b|7M4|7RM5|7SM3)|ILME-FX3)/
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator
            ...
            .unwrap_or(false)
        {
            debug!("Model condition matched: $$self{{Model}} =~ /^(ILCE-(1\\b|7M4|7RM5|7SM3)|ILME-FX3)/ for sony_tag9050c");
            return process_sony_tag9050c(data, byte_order);
        }
    }
    // Model condition: $$self{Model} =~ /^(ILCE-(6700|7CM2|7CR)|ZV-(E1|E10M2))\\b/ or ($$self{Model} =~ /^(ILCE-1M2)/ and $$valPt =~ /^\\x00/)
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator.evaluate_context_condition(&processor_context, "$$self{Model} =~ /^(ILCE-(6700|7CM2|7CR)|ZV-(E1|E10M2))\\b/ or ($$self{Model} =~ /^(ILCE-1M2)/ and $$valPt =~ /^\\x00/)").unwrap_or(false) {
            debug!("Model condition matched: $$self{{Model}} =~ /^(ILCE-(6700|7CM2|7CR)|ZV-(E1|E10M2))\\b/ or ($$self{{Model}} =~ /^(ILCE-1M2)/ and $$valPt =~ /^\\x00/) for sony_tag9050d");
            return process_sony_tag9050d(data, byte_order);
        }
    }
    Ok(vec![])
}
...
pub fn process_tag_0x9402_subdirectory(
    ...
    // Model condition: $$self{Model} !~ /^(SLT-|HV|ILCA-)/ and $$valPt !~ /^[\\x05\\xff]/
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator
            ...
            .unwrap_or(false)
        {
            debug!("Model condition matched: $$self{{Model}} !~ /^(SLT-|HV|ILCA-)/ and $$valPt !~ /^[\\x05\\xff]/ for sony_tag9402");
            return process_sony_tag9402(data, byte_order);
        }
    }
    Ok(vec![])
}
...
pub fn process_tag_0x940a_subdirectory(
    ...
    // Model condition: $$self{Model} =~ /^(SLT-|HV)/
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator
            .evaluate_context_condition(&processor_context, "$$self{Model} =~ /^(SLT-|HV)/")
            .unwrap_or(false)
        {
            debug!("Model condition matched: $$self{{Model}} =~ /^(SLT-|HV)/ for sony_tag940a");
            return process_sony_tag940a(data, byte_order);
        }
    }
    Ok(vec![])
}
...
pub fn process_tag_0x940c_subdirectory(
    ...
    // Model condition: $$self{Model} =~ /^(NEX-|ILCE-|ILME-|Lunar|ZV-E10|ZV-E10M2|ZV-E1)\\b/
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator
            ...
            .unwrap_or(false)
        {
            debug!("Model condition matched: $$self{{Model}} =~ /^(NEX-|ILCE-|ILME-|Lunar|ZV-E10|ZV-E10M2|ZV-E1)\\b/ for sony_tag940c");
            return process_sony_tag940c(data, byte_order);
        }
    }
    Ok(vec![])
}
...
pub fn process_tag_0x940e_subdirectory(
    ...
    // Model condition: $$self{Model} =~ /^(SLT-|HV|ILCA-)/
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator
            .evaluate_context_condition(&processor_context, "$$self{Model} =~ /^(SLT-|HV|ILCA-)/")
            .unwrap_or(false)
        {
            debug!(
                "Model condition matched: $$self{{Model}} =~ /^(SLT-|HV|ILCA-)/ for sony_afinfo"
            );
            return process_sony_afinfo(data, byte_order);
        }
    }
    // Model condition: $$self{Model} =~ /^(NEX-|ILCE-|Lunar)/
    if let Some(model) = &model {
        let mut evaluator = ExpressionEvaluator::new();
        let processor_context = ProcessorContext::default().with_model(model.to_string());
        if evaluator
            .evaluate_context_condition(
                &processor_context,
                "$$self{Model} =~ /^(NEX-|ILCE-|Lunar)/",
            )
            .unwrap_or(false)
        {
            debug!("Model condition matched: $$self{{Model}} =~ /^(NEX-|ILCE-|Lunar)/ for sony_tag940e");
            return process_sony_tag940e(data, byte_order);
        }
    }
    Ok(vec![])
}
...
pub fn apply_print_conv(
    ...
    match tag_id {
        ...
        102 => crate::implementations::print_conv::exposuretime_print_conv(value),
        118 => crate::implementations::print_conv::flash_print_conv(value),
        32768 => crate::implementations::print_conv::fnumber_print_conv(value),
        33033 => crate::implementations::print_conv::exposuretime_print_conv(value),
        34049 => crate::implementations::print_conv::gpslatituderef_print_conv(value),
        34051 => crate::implementations::print_conv::gpslongituderef_print_conv(value),
        _ => {
...
pub fn apply_value_conv(
    ...
    match tag_id {
        ...
        34077 => crate::implementations::value_conv::exif_date_value_conv(value),
        36944 => {
            if let Some(tag_kit) = SONY_PM_TAG_KITS.get(&tag_id) {
                if let Some(expr) = tag_kit.value_conv {
                    Ok(crate::implementations::missing::missing_value_conv(
        ...
        3 => {
            ...
            match value.as_f64() {
                Some(val) => Ok(TagValue::F64((val - 128.0_f64) / 24.0_f64)),
                None => Ok(value.clone()),
            }
        }
        4 => {
            ...
            match value.as_f64() {
                Some(val) => Ok(TagValue::F64(val + 1.0_f64)),
                None => Ok(value.clone()),
            }
        }
        5 => {
            // Compiled arithmetic: $val > 128 ? $val - 256 : $val
            match value.as_f64() {
                Some(val) => Ok(if val > 128.0_f64 {
                    TagValue::F64(val - 256.0_f64)
                } else {
                    TagValue::F64(val)
                }),
                None => Ok(value.clone()),
        ...
        10 => {
            ...
            match value.as_f64() {
                Some(val) => Ok(TagValue::F64(16.0_f64 - (val / 256.0_f64))),
                None => Ok(value.clone()),
            }
        }
        11 => {
        ...
        16 => {
            ...
            match value.as_f64() {
                Some(val) => Ok(TagValue::F64((val * 2.0_f64) / 3.0_f64)),
                None => Ok(value.clone()),
            }
        }
        18 => {
        ...
        22 => {
            // Compiled arithmetic: $val ? exp(($val/8-6)*log(2))*100 : $val
            match value.as_f64() {
                Some(val) => Ok(if val != 0.0 {
                    TagValue::F64((((val / 8.0_f64) - 6.0_f64) * 2.0_f64.ln()).exp() * 100.0_f64)
                } else {
                    TagValue::F64(val)
                }),
                None => Ok(value.clone()),
        ...
        37 => {
            // Compiled arithmetic: 10 * 2 ** (($val-28)/16)
            match value.as_f64() {
                Some(val) => Ok(TagValue::F64(
                    10.0_f64 * 2.0_f64.powf(val - 28.0_f64 / 16.0_f64),
                )),
                None => Ok(value.clone()),
            }
        }
        ...
        58 => {
            // Compiled arithmetic: $val ? 2 ** (16 - $val/256) : 0
            match value.as_f64() {
                Some(val) => Ok(if val != 0.0 {
                    TagValue::F64(2.0_f64.powf(16.0_f64 - val / 256.0_f64))
                } else {
        ...
        60 => {
            // Compiled arithmetic: 2 ** (($val/256 - 16) / 2)
            match value.as_f64() {
                Some(val) => Ok(TagValue::F64(
                    2.0_f64.powf(val / 256.0_f64 - 16.0_f64 / 2.0_f64),
                )),
                None => Ok(value.clone()),
            }
        }
        ...
        102 => {
            // Compiled arithmetic: 2 ** (-$val / 100)
            match value.as_f64() {
                Some(val) => Ok(TagValue::F64(2.0_f64.powf(-val / 100.0_f64))),
                None => Ok(value.clone()),
            }
        }
        104 => {
        ...
        304 => {
            ...
            match value.as_f64() {
                Some(val) => Ok(TagValue::F64(val - 20.0_f64)),
                None => Ok(value.clone()),
            }
        }
        512 => {
            ...
            match value.as_f64() {
                Some(val) => Ok(TagValue::F64(val / 16.0_f64)),
                None => Ok(value.clone()),
            }
        }
        535 => {
        ...
        537 => {
            ...
            match value.as_f64() {
                Some(val) => Ok(TagValue::F64((val / 256.0_f64) - 56.6_f64)),
                None => Ok(value.clone()),
            }
        }
        540 => {
        ...
        800 => {
            // Compiled arithmetic: 100 * 2**(16 - $val/256)
            match value.as_f64() {
                Some(val) => Ok(TagValue::F64(
                    100.0_f64 * 2.0_f64.powf(16.0_f64 - val / 256.0_f64),
                )),
                None => Ok(value.clone()),
            }
        }
        ...
        32768 => {
            // Compiled arithmetic: 2 ** (8-$val/8192)
            match value.as_f64() {
                Some(val) => Ok(TagValue::F64(2.0_f64.powf(8.0_f64 - val / 8192.0_f64))),
                None => Ok(value.clone()),
            }
        }
        33034 => {
