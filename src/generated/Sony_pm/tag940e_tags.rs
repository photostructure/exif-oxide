//! Generated tag table definitions from Sony::Tag940e
//!
...
/// Tag definitions for Sony::Tag940e table
pub static SONY_TAG940E_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            6662,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = SONY_TAG940E_TAGS.get(&tag_id_u16) {
