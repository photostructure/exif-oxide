//! Generated tag table definitions from Sony::Tag9404c
//!
...
/// Tag definitions for Sony::Tag9404c table
pub static SONY_TAG9404C_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            11,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = SONY_TAG9404C_TAGS.get(&tag_id_u16) {
