...
pub static FOCUS_INFO_EXTERNAL_FLASH: LazyLock<HashMap<&'static str, &'static str>> = LazyLock::new(|| {
    FOCUS_INFO_EXTERNAL_FLASH_DATA.iter().cloned().collect()
});
...
/// Lookup table (lazy-initialized)
pub static FOCUS_INFO_EXTERNAL_FLASH_BOUNCE: LazyLock<HashMap<u8, &'static str>> = LazyLock::new(|| {
    FOCUS_INFO_EXTERNAL_FLASH_BOUNCE_DATA.iter().cloned().collect()
});
...
/// Lookup table (lazy-initialized)
pub static FOCUS_INFO_INTERNAL_FLASH: LazyLock<HashMap<&'static str, &'static str>> = LazyLock::new(|| {
    FOCUS_INFO_INTERNAL_FLASH_DATA.iter().cloned().collect()
});
...
/// Raw data (2 entries)
static FOCUS_INFO_MACRO_L_E_D_DATA: &[(u8, &'static str)] = &[
    (0, "Off"),
    (1, "On"),
];

/// Lookup table (lazy-initialized)
pub static FOCUS_INFO_MACRO_L_E_D: LazyLock<HashMap<u8, &'static str>> = LazyLock::new(|| {
    FOCUS_INFO_MACRO_L_E_D_DATA.iter().cloned().collect()
});
...
/// Raw data (2 entries)
static FOCUS_INFO_AUTO_FOCUS_DATA: &[(u8, &'static str)] = &[
    (0, "Off"),
    (1, "On"),
];

/// Lookup table (lazy-initialized)
pub static FOCUS_INFO_AUTO_FOCUS: LazyLock<HashMap<u8, &'static str>> = LazyLock::new(|| {
    FOCUS_INFO_AUTO_FOCUS_DATA.iter().cloned().collect()
});
