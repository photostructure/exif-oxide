//! Generated tag table definitions from MIE::GPS
//!
...
/// Tag definitions for MIE::GPS table
pub static MIE_GPS_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = MIE_GPS_TAGS.get(&tag_id_u16) {
