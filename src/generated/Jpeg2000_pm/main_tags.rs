//! Generated tag table definitions from Jpeg2000::Main
//!
...
/// Tag definitions for Jpeg2000::Main table
pub static JPEG2000_MAIN_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = JPEG2000_MAIN_TAGS.get(&tag_id_u16) {
