//! Generated tag table definitions from Jpeg2000::FileType
//!
        ...
        (
            ...
            TagInfo {
                ...
                value_conv: Some(ValueConv::Expression(
                    "sprintf(\"%x.%x.%x\", unpack(\"nCC\", $val))".to_string(),
                )),
            },
        ),
        (
            ...
            TagInfo {
                ...
                print_conv: None,
                value_conv: Some(ValueConv::Expression(
                    "my @a=($val=~/.{4}/sg); @a=grep(!/\\0/,@a); \\@a".to_string(),
                )),
            },
        ),
    ])
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = JPEG2000_FILETYPE_TAGS.get(&tag_id_u16) {
