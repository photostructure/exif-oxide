//! Generated tag table definitions from DJI::XMP
//!
...
/// Tag definitions for DJI::XMP table
pub static DJI_XMP_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = DJI_XMP_TAGS.get(&tag_id_u16) {
