...
pub fn get_exif_specific_tags() -> Vec<(u32, TagKitDef)> {
    vec![
        ...
        (33723, TagKitDef {
            ...
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: Some(SubDirectoryType::Binary { processor: process_tag_0x83bb_subdirectory }),
        }),
        (33920, TagKitDef {
            id: 33920,
        ...
        (34152, TagKitDef {
            ...
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: Some(SubDirectoryType::Binary { processor: process_tag_0x8568_subdirectory }),
        }),
        (34264, TagKitDef {
            id: 34264,
            name: "ModelTransform",
        ...
        (34310, TagKitDef {
            ...
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: Some(SubDirectoryType::Binary { processor: process_tag_0x8606_subdirectory }),
        }),
        (34377, TagKitDef {
            id: 34377,
            ...
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: Some(SubDirectoryType::Binary { processor: process_tag_0x8649_subdirectory }),
        }),
        (34665, TagKitDef {
            id: 34665,
            name: "ExifOffset",
            ...
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: Some(SubDirectoryType::Binary { processor: process_tag_0x8769_subdirectory }),
        }),
        (34675, TagKitDef {
            id: 34675,
            name: "ICC_Profile",
            ...
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: Some(SubDirectoryType::Binary { processor: process_tag_0x8773_subdirectory }),
        }),
        (34687, TagKitDef {
            id: 34687,
        ...
        (34855, TagKitDef {
            ...
            print_conv: PrintConvType::Expression(r"$val=~s/\s+/, /g; $val"),
            value_conv: None,
            subdirectory: None,
        }),
        (34856, TagKitDef {
        ...
        (34954, TagKitDef {
            ...
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: Some(SubDirectoryType::Binary { processor: process_tag_0x888a_subdirectory }),
        }),
        (36864, TagKitDef {
            id: 36864,
            name: "ExifVersion",
        ...
        (37377, TagKitDef {
            ...
            value_conv: Some("apex_shutter_speed_value_conv"),
            subdirectory: None,
        }),
        (37378, TagKitDef {
            id: 37378,
        ...
        (37500, TagKitDef {
            ...
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: Some(SubDirectoryType::Binary { processor: process_tag_0x927c_subdirectory }),
        }),
        (37500, TagKitDef {
            id: 37500,
            name: "MakerNoteNikon",
        ...
        (37500, TagKitDef {
            ...
            groups: HashMap::new(),
            writable: true,
            notes: Some("Samsung \"STMN\" maker notes without PreviewImage"),
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: None,
        }),
        ...
        (37500, TagKitDef {
            ...
            groups: HashMap::new(),
            writable: true,
            notes: Some("unknown text-based maker notes"),
            print_conv: PrintConvType::None,
            value_conv: Some("reference_very_long_string_value_conv"),
            subdirectory: None,
        }),
        (37500, TagKitDef {
            id: 37500,
            ...
            groups: HashMap::new(),
            writable: true,
            notes: Some("unknown binary maker notes"),
            print_conv: PrintConvType::None,
            value_conv: None,
            subdirectory: None,
        }),
