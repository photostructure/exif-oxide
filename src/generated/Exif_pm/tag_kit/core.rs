...
static PRINT_CONV_65: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    ...
    map.insert("3".to_string(), "Single page of multi-page reduced-resolution image");
    map.insert("4".to_string(), "Transparency mask");
    map.insert("4294967295".to_string(), "invalid");
    map.insert("5".to_string(), "Transparency mask of reduced-resolution image");
    ...
    map.insert("7".to_string(), "Transparency mask of reduced-resolution multi-page image");
...
static PRINT_CONV_67: LazyLock<HashMap<String, &'static str>> = LazyLock::new(|| {
    ...
    map.insert("34718".to_string(), "Microsoft Document Imaging (MDI) Binary Level Codec");
    map.insert("34719".to_string(), "Microsoft Document Imaging (MDI) Progressive Transform Codec");
    map.insert("34720".to_string(), "Microsoft Document Imaging (MDI) Vector");
