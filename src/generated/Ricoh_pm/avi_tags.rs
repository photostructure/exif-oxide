//! Generated tag table definitions from Ricoh::AVI
//!
...
/// Tag definitions for Ricoh::AVI table
pub static RICOH_AVI_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = RICOH_AVI_TAGS.get(&tag_id_u16) {
