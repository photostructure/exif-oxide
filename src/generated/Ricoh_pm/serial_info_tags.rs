//! Generated tag table definitions from Ricoh::SerialInfo
//!
...
/// Tag definitions for Ricoh::SerialInfo table
pub static RICOH_SERIALINFO_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            0,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = RICOH_SERIALINFO_TAGS.get(&tag_id_u16) {
