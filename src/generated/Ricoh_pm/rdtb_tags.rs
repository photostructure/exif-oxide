//! Generated tag table definitions from Ricoh::RDTB
//!
...
/// Tag definitions for Ricoh::RDTB table
pub static RICOH_RDTB_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            0,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = RICOH_RDTB_TAGS.get(&tag_id_u16) {
