//! Generated tag table definitions from Ricoh::Text
//!
...
/// Tag definitions for Ricoh::Text table
pub static RICOH_TEXT_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| HashMap::new());
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = RICOH_TEXT_TAGS.get(&tag_id_u16) {
