...
pub static COMPOSITE_TAGS: &[CompositeTagDef] = &[
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[],
        desire: &[(7, "WB_GRBLevels"), (2, "WB_RBGGLevels"), (4, "WB_GRGBLevels"), (3, "WB_GRBGLevels"), (10, "WBGreenLevel"), (5, "WB_GBRGLevels"), (9, "WBBlueLevel"), (1, "WB_RGBGLevels"), (0, "WB_RGGBLevels"), (8, "WB_RBLevels"), (6, "WB_RGBLevels"), ],
    ...
    CompositeTagDef {
        ...
        desire: &[(8, "FocusDistanceUpper"), (4, "SubjectDistance"), (3, "FocusDistance"), (5, "ObjectDistance"), (6, "ApproximateFocusDistance"), (7, "FocusDistanceLower"), ],
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[(0, "LensType"), ],
        desire: &[(8, "LensSpec"), (2, "MaxAperture"), (5, "MaxFocalLength"), (11, "LensFocalLength"), (1, "FocalLength"), (9, "LensType2"), (6, "LensModel"), (7, "LensFocalRange"), (10, "LensType3"), (4, "MinFocalLength"), (12, "RFLensType"), (3, "MaxApertureValue"), ],
        value_conv: Some("$val"),
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[],
        desire: &[(4, "WB_GRGBLevels"), (5, "WB_GBRGLevels"), (2, "WB_RBGGLevels"), (0, "WB_RGGBLevels"), (10, "WBGreenLevel"), (7, "WB_GRBLevels"), (3, "WB_GRBGLevels"), (6, "WB_RGBLevels"), (9, "WBRedLevel"), (8, "WB_RBLevels"), (1, "WB_RGBGLevels"), ],
    ...
    CompositeTagDef {
        ...
        require: &[],
        desire: &[(5, "FocalPlaneXSize"), (12, "CanonImageWidth"), (9, "FocalPlaneYResolution"), (8, "FocalPlaneXResolution"), (3, "FocalPlaneDiagonal"), (14, "ImageWidth"), (11, "ExifImageHeight"), (10, "ExifImageWidth"), (15, "ImageHeight"), (13, "CanonImageHeight"), (2, "Composite:DigitalZoom"), (7, "FocalPlaneResolutionUnit"), (1, "FocalLengthIn35mmFormat"), (6, "FocalPlaneYSize"), (0, "FocalLength"), (4, "SensorSize"), ],
    ...
    CompositeTagDef {
        ...
        table: "Main",
        description: None,
        require: &[(0, "SubfileType"), (4, "BitsPerSample"), (9, "StripByteCounts"), (7, "SamplesPerPixel"), (2, "ImageWidth"), (8, "RowsPerStrip"), (5, "PhotometricInterpretation"), (3, "ImageHeight"), (1, "Compression"), (6, "StripOffsets"), ],
        desire: &[(10, "PlanarConfiguration"), (11, "Orientation"), ],
        value_conv: None,
        print_conv_ref: None,
        groups: &[(2, "Preview"), (0, "Composite"), (1, "Composite"), ],
        writable: false,
        avoid: false,
        priority: 0,
        notes: None,
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[],
        desire: &[(7, "WB_GRBLevels"), (6, "WB_RGBLevels"), (5, "WB_GBRGLevels"), (4, "WB_GRGBLevels"), (8, "WB_RBLevels"), (3, "WB_GRBGLevels"), (0, "WB_RGGBLevels"), (1, "WB_RGBGLevels"), (10, "WBGreenLevel"), (9, "WBBlueLevel"), (2, "WB_RBGGLevels"), ],
        value_conv: Some("Image::ExifTool::Exif::RedBlueBalance(1,@val)"),
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[(0, "LensType"), ],
        desire: &[(4, "MinFocalLength"), (10, "LensType3"), (5, "MaxFocalLength"), (1, "FocalLength"), (9, "LensType2"), (11, "LensFocalLength"), (6, "LensModel"), (8, "LensSpec"), (7, "LensFocalRange"), (2, "MaxAperture"), (3, "MaxApertureValue"), (12, "RFLensType"), ],
        value_conv: Some("$val"),
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[],
        desire: &[(7, "WB_GRBLevels"), (2, "WB_RBGGLevels"), (8, "WB_RBLevels"), (3, "WB_GRBGLevels"), (0, "WB_RGGBLevels"), (5, "WB_GBRGLevels"), (6, "WB_RGBLevels"), (9, "WBRedLevel"), (10, "WBGreenLevel"), (1, "WB_RGBGLevels"), (4, "WB_GRGBLevels"), ],
        value_conv: Some("Image::ExifTool::Exif::RedBlueBalance(0,@val)"),
    ...
    CompositeTagDef {
        ...
        description: Some("Scale Factor To 35 mm Equivalent"),
        require: &[],
        desire: &[(6, "FocalPlaneYSize"), (3, "FocalPlaneDiagonal"), (14, "ImageWidth"), (15, "ImageHeight"), (2, "Composite:DigitalZoom"), (10, "ExifImageWidth"), (7, "FocalPlaneResolutionUnit"), (4, "SensorSize"), (8, "FocalPlaneXResolution"), (5, "FocalPlaneXSize"), (1, "FocalLengthIn35mmFormat"), (13, "CanonImageHeight"), (11, "ExifImageHeight"), (0, "FocalLength"), (9, "FocalPlaneYResolution"), (12, "CanonImageWidth"), ],
        value_conv: Some("Image::ExifTool::Exif::CalcScaleFactor35efl($self, @val)"),
    ...
    CompositeTagDef {
        ...
        table: "EXIF",
        description: None,
        require: &[(7, "SamplesPerPixel"), (1, "Compression"), (9, "StripByteCounts"), (4, "BitsPerSample"), (3, "ImageHeight"), (8, "RowsPerStrip"), (0, "SubfileType"), (2, "ImageWidth"), (6, "StripOffsets"), (5, "PhotometricInterpretation"), ],
        desire: &[(10, "PlanarConfiguration"), (11, "Orientation"), ],
        value_conv: None,
        print_conv_ref: None,
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[],
        desire: &[(2, "XMP:GPSAltitude"), (3, "XMP:GPSAltitudeRef"), (0, "GPS:GPSAltitude"), (1, "GPS:GPSAltitudeRef"), ],
        value_conv: Some("\n            foreach (0,2) {\n                next unless defined $val[$_] and IsFloat($val[$_]) and defined $val[$_+1];\n                return $val[$_+1] ? -abs($val[$_]) : $val[$_];\n            }\n            return undef;\n        "),
