...
pub static COMPOSITE_TAGS: &[CompositeTagDef] = &[
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[],
        desire: &[(3, "WB_GRBGLevels"), (4, "WB_GRGBLevels"), (5, "WB_GBRGLevels"), (2, "WB_RBGGLevels"), (8, "WB_RBLevels"), (10, "WBGreenLevel"), (6, "WB_RGBLevels"), (9, "WBBlueLevel"), (1, "WB_RGBGLevels"), (0, "WB_RGGBLevels"), (7, "WB_GRBLevels"), ],
    ...
    CompositeTagDef {
        ...
        require: &[(1, "Aperture"), (2, "CircleOfConfusion"), (0, "FocalLength"), ],
        desire: &[(3, "FocusDistance"), (4, "SubjectDistance"), (7, "FocusDistanceLower"), (5, "ObjectDistance"), (8, "FocusDistanceUpper"), (6, "ApproximateFocusDistance"), ],
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[(0, "LensType"), ],
        desire: &[(6, "LensModel"), (7, "LensFocalRange"), (9, "LensType2"), (1, "FocalLength"), (4, "MinFocalLength"), (3, "MaxApertureValue"), (11, "LensFocalLength"), (8, "LensSpec"), (12, "RFLensType"), (5, "MaxFocalLength"), (2, "MaxAperture"), (10, "LensType3"), ],
        value_conv: Some("$val"),
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[],
        desire: &[(6, "WB_RGBLevels"), (5, "WB_GBRGLevels"), (0, "WB_RGGBLevels"), (10, "WBGreenLevel"), (3, "WB_GRBGLevels"), (2, "WB_RBGGLevels"), (9, "WBRedLevel"), (8, "WB_RBLevels"), (7, "WB_GRBLevels"), (1, "WB_RGBGLevels"), (4, "WB_GRGBLevels"), ],
    ...
    CompositeTagDef {
        ...
        require: &[],
        desire: &[(15, "ImageHeight"), (10, "ExifImageWidth"), (9, "FocalPlaneYResolution"), (4, "SensorSize"), (13, "CanonImageHeight"), (14, "ImageWidth"), (5, "FocalPlaneXSize"), (0, "FocalLength"), (6, "FocalPlaneYSize"), (3, "FocalPlaneDiagonal"), (2, "Composite:DigitalZoom"), (12, "CanonImageWidth"), (1, "FocalLengthIn35mmFormat"), (7, "FocalPlaneResolutionUnit"), (8, "FocalPlaneXResolution"), (11, "ExifImageHeight"), ],
    ...
    CompositeTagDef {
        ...
        table: "Main",
        description: None,
        require: &[(6, "StripOffsets"), (1, "Compression"), (9, "StripByteCounts"), (2, "ImageWidth"), (7, "SamplesPerPixel"), (5, "PhotometricInterpretation"), (3, "ImageHeight"), (8, "RowsPerStrip"), (4, "BitsPerSample"), (0, "SubfileType"), ],
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[],
        desire: &[(3, "XMP:GPSAltitudeRef"), (2, "XMP:GPSAltitude"), (1, "GPS:GPSAltitudeRef"), (0, "GPS:GPSAltitude"), ],
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[],
        desire: &[(10, "WBGreenLevel"), (8, "WB_RBLevels"), (3, "WB_GRBGLevels"), (4, "WB_GRGBLevels"), (0, "WB_RGGBLevels"), (5, "WB_GBRGLevels"), (1, "WB_RGBGLevels"), (6, "WB_RGBLevels"), (2, "WB_RBGGLevels"), (9, "WBBlueLevel"), (7, "WB_GRBLevels"), ],
        value_conv: Some("Image::ExifTool::Exif::RedBlueBalance(1,@val)"),
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[(0, "LensType"), ],
        desire: &[(5, "MaxFocalLength"), (6, "LensModel"), (1, "FocalLength"), (7, "LensFocalRange"), (10, "LensType3"), (3, "MaxApertureValue"), (9, "LensType2"), (11, "LensFocalLength"), (2, "MaxAperture"), (8, "LensSpec"), (4, "MinFocalLength"), (12, "RFLensType"), ],
        value_conv: Some("$val"),
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[(0, "PreviewImageStart"), (1, "PreviewImageLength"), ],
        desire: &[(2, "PreviewImageValid"), (4, "PreviewImageLength (1)"), (3, "PreviewImageStart (1)"), ],
        value_conv: None,
        print_conv_ref: None,
        groups: &[(1, "SubIFD"), (2, "Preview"), (0, "EXIF"), ],
        writable: true,
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[],
        desire: &[(2, "WB_RBGGLevels"), (10, "WBGreenLevel"), (7, "WB_GRBLevels"), (8, "WB_RBLevels"), (1, "WB_RGBGLevels"), (3, "WB_GRBGLevels"), (6, "WB_RGBLevels"), (5, "WB_GBRGLevels"), (4, "WB_GRGBLevels"), (0, "WB_RGGBLevels"), (9, "WBRedLevel"), ],
        value_conv: Some("Image::ExifTool::Exif::RedBlueBalance(0,@val)"),
    ...
    CompositeTagDef {
        ...
        description: Some("Scale Factor To 35 mm Equivalent"),
        require: &[],
        desire: &[(9, "FocalPlaneYResolution"), (1, "FocalLengthIn35mmFormat"), (7, "FocalPlaneResolutionUnit"), (14, "ImageWidth"), (3, "FocalPlaneDiagonal"), (8, "FocalPlaneXResolution"), (15, "ImageHeight"), (2, "Composite:DigitalZoom"), (12, "CanonImageWidth"), (10, "ExifImageWidth"), (6, "FocalPlaneYSize"), (5, "FocalPlaneXSize"), (0, "FocalLength"), (11, "ExifImageHeight"), (4, "SensorSize"), (13, "CanonImageHeight"), ],
        value_conv: Some("Image::ExifTool::Exif::CalcScaleFactor35efl($self, @val)"),
    ...
    CompositeTagDef {
        ...
        table: "EXIF",
        description: None,
        require: &[(3, "ImageHeight"), (1, "Compression"), (8, "RowsPerStrip"), (2, "ImageWidth"), (0, "SubfileType"), (7, "SamplesPerPixel"), (6, "StripOffsets"), (5, "PhotometricInterpretation"), (9, "StripByteCounts"), (4, "BitsPerSample"), ],
        desire: &[(11, "Orientation"), (10, "PlanarConfiguration"), ],
        value_conv: None,
        print_conv_ref: None,
        groups: &[(2, "Preview"), (1, "Composite"), (0, "Composite"), ],
        writable: false,
        avoid: false,
        priority: 0,
        notes: None,
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[],
        desire: &[(0, "GPS:GPSAltitude"), (2, "XMP:GPSAltitude"), (3, "XMP:GPSAltitudeRef"), (1, "GPS:GPSAltitudeRef"), ],
        value_conv: Some("\n            foreach (0,2) {\n                next unless defined $val[$_] and IsFloat($val[$_]) and defined $val[$_+1];\n                return $val[$_+1] ? -abs($val[$_]) : $val[$_];\n            }\n            return undef;\n        "),
