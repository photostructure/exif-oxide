...
pub fn composite_valueconv_exif_aperture(
    ...
    Ok({
        let logical_left = vals.first().cloned().unwrap_or(TagValue::Empty);
...
pub fn composite_valueconv_exif_datetimeoriginal(
    vals: &[TagValue],
    prts: &[TagValue],
    raws: &[TagValue],
    ctx: Option<&ExifContext>,
) -> Result<TagValue, crate::core::types::ExifError> {
    {
        if (vals.first().cloned().unwrap_or(TagValue::Empty)).is_truthy()
            && vals
                ...
                .contains(r" ")
        {
            return Ok(vals.first().cloned().unwrap_or(TagValue::Empty));
        };
...
pub fn composite_valueconv_exif_gpsposition(
    vals: &[TagValue],
    prts: &[TagValue],
    raws: &[TagValue],
    ctx: Option<&ExifContext>,
    ...
    Ok(
        if (crate::core::length_i32(vals.first().cloned().unwrap_or(TagValue::Empty))).is_truthy()
            || (crate::core::length_i32(vals.get(1).cloned().unwrap_or(TagValue::Empty)))
                .is_truthy()
        {
...
pub fn composite_valueconv_gps_gpsdestlatitude(
    ...
    Ok(
        if {
            use regex::Regex;
            use std::sync::LazyLock;
            static REGEX_F0BB09E88B6D529A: LazyLock<Regex> =
...
pub fn composite_valueconv_gps_gpsdestlongitude(
    ...
    Ok(
        if {
            use regex::Regex;
            use std::sync::LazyLock;
            static REGEX_7F53CDA04B3D5152: LazyLock<Regex> =
...
pub fn composite_valueconv_canon_iso(
    vals: &[TagValue],
    prts: &[TagValue],
    raws: &[TagValue],
    ctx: Option<&ExifContext>,
) -> Result<TagValue, crate::core::types::ExifError> {
    {
        if (vals.first().cloned().unwrap_or(TagValue::Empty)).is_truthy() && {
            use regex::Regex;
            use std::sync::LazyLock;
            static REGEX_FB69BFFEC4DAECF7: LazyLock<Regex> =
                LazyLock::new(|| Regex::new(r"^\d+$").unwrap());
            REGEX_FB69BFFEC4DAECF7
        ...
        {
            return Ok(TagValue::String("".to_string()));
        };
        return Ok(Into::<TagValue>::into(
            vals.get(1).cloned().unwrap_or(TagValue::Empty)
                * vals.get(2).cloned().unwrap_or(TagValue::Empty)
                / 100i32 as f64,
        ));
...
pub fn composite_valueconv_canon_redeyereduction(
    vals: &[TagValue],
    prts: &[TagValue],
    raws: &[TagValue],
    ctx: Option<&ExifContext>,
...
pub fn composite_valueconv_canon_shootingmode(
    vals: &[TagValue],
    prts: &[TagValue],
    raws: &[TagValue],
    ctx: Option<&ExifContext>,
...
pub fn composite_valueconv_nikon_contrastdetectaf(
    vals: &[TagValue],
    prts: &[TagValue],
    raws: &[TagValue],
    ctx: Option<&ExifContext>,
    ...
    Ok(
        if {
            ...
            !REGEX_79469736F9FB14CD
                .is_match(&vals.first().cloned().unwrap_or(TagValue::Empty).to_string())
        } && vals.get(1).cloned().unwrap_or(TagValue::Empty) == 1i32
        {
            Into::<TagValue>::into(1i32)
        } else {
            Into::<TagValue>::into(0i32)
...
pub fn composite_valueconv_sony_focusdistance2(
    vals: &[TagValue],
    prts: &[TagValue],
    raws: &[TagValue],
    ctx: Option<&ExifContext>,
) -> Result<TagValue, crate::core::types::ExifError> {
    {
        ...
        if vals.first().cloned().unwrap_or(TagValue::Empty) >= 255i32 {
            return Ok(Into::<TagValue>::into("inf"));
        };
        return Ok(Into::<TagValue>::into(
            (crate::core::power(
                Into::<TagValue>::into(2i32),
                Into::<TagValue>::into(
                    vals.first().cloned().unwrap_or(TagValue::Empty) / 16i32 as f64 - 5i32,
                ),
            ) + 1i32)
                * vals.get(1).cloned().unwrap_or(TagValue::Empty)
                / 1000i32 as f64,
...
// =============================================================================
// End Generated Composite Functions
// =============================================================================
...
pub static COMPOSITE_EXIF_APERTURE: CompositeTagDef = CompositeTagDef {
    ...
    inhibit: &[],
    value_conv: Some(composite_valueconv_exif_aperture),
...
pub static COMPOSITE_EXIF_CIRCLEOFCONFUSION: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_exif_circleofconfusion),
    print_conv: Some(composite_printconv_exif_circleofconfusion),
...
pub static COMPOSITE_EXIF_DATETIMEORIGINAL: CompositeTagDef = CompositeTagDef {
    ...
    inhibit: &[],
    value_conv: Some(composite_valueconv_exif_datetimeoriginal),
    print_conv: None, // PPI generation failed
...
pub static COMPOSITE_EXIF_GPSPOSITION: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_exif_gpsposition),
    print_conv: Some(composite_printconv_exif_gpsposition),
...
pub static COMPOSITE_EXIF_HYPERFOCALDISTANCE: CompositeTagDef = CompositeTagDef {
    ...
    inhibit: &[],
    value_conv: None, // PPI generation failed
    print_conv: Some(composite_printconv_exif_hyperfocaldistance),
...
pub static COMPOSITE_EXIF_LENSID: CompositeTagDef = CompositeTagDef {
    ...
    inhibit: &[],
    value_conv: Some(composite_valueconv_exif_lensid),
    print_conv: None, // PPI generation failed
...
pub static COMPOSITE_EXIF_LIGHTVALUE: CompositeTagDef = CompositeTagDef {
    ...
    inhibit: &[],
    value_conv: None, // PPI generation failed
    print_conv: Some(composite_printconv_exif_lightvalue),
...
pub static COMPOSITE_EXIF_MEGAPIXELS: CompositeTagDef = CompositeTagDef {
    ...
    inhibit: &[],
    value_conv: None, // PPI generation failed
    print_conv: Some(composite_printconv_exif_megapixels),
...
pub static COMPOSITE_EXIF_PREVIEWIMAGESIZE: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_exif_previewimagesize),
    print_conv: None,
...
pub static COMPOSITE_EXIF_SCALEFACTOR35EFL: CompositeTagDef = CompositeTagDef {
    ...
    inhibit: &[],
    value_conv: None, // PPI generation failed
    print_conv: Some(composite_printconv_exif_scalefactor35efl),
...
pub static COMPOSITE_GPS_GPSDATETIME: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_gps_gpsdatetime),
    print_conv: None, // PPI generation failed
...
pub static COMPOSITE_GPS_GPSDESTLATITUDE: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_gps_gpsdestlatitude),
    print_conv: None, // PPI generation failed
...
pub static COMPOSITE_GPS_GPSDESTLONGITUDE: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_gps_gpsdestlongitude),
    print_conv: None, // PPI generation failed
...
pub static COMPOSITE_GPS_GPSLATITUDE: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_gps_gpslatitude),
    print_conv: None, // PPI generation failed
    value_conv_expr: Some(r"$val[1] =~ /^S/i ? -$val[0] : $val[0]"),
    print_conv_expr: Some("Image::ExifTool::GPS::ToDMS($self, $val, 1, \"N\")"),
    description: None,
...
pub static COMPOSITE_GPS_GPSLONGITUDE: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_gps_gpslongitude),
    print_conv: None, // PPI generation failed
    value_conv_expr: Some(r"$val[1] =~ /^W/i ? -$val[0] : $val[0]"),
    print_conv_expr: Some("Image::ExifTool::GPS::ToDMS($self, $val, 1, \"E\")"),
    description: None,
...
pub static COMPOSITE_IPTC_DATETIMECREATED: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_iptc_datetimecreated),
    print_conv: None, // PPI generation failed
    value_conv_expr: Some("\"$val[0] $val[1]\""),
    print_conv_expr: Some("$self->ConvertDateTime($val)"),
...
pub static COMPOSITE_IPTC_DIGITALCREATIONDATETIME: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_iptc_digitalcreationdatetime),
    print_conv: None, // PPI generation failed
    value_conv_expr: Some("\"$val[0] $val[1]\""),
    print_conv_expr: Some("$self->ConvertDateTime($val)"),
...
pub static COMPOSITE_APPLE_RUNTIMESINCEPOWERUP: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_apple_runtimesincepowerup),
    print_conv: None, // PPI generation failed
...
pub static COMPOSITE_CANON_CONDITIONALFEC: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_canon_conditionalfec),
    print_conv: Some(composite_printconv_canon_conditionalfec),
...
pub static COMPOSITE_CANON_DIGITALZOOM: CompositeTagDef = CompositeTagDef {
    ...
    inhibit: &[],
    value_conv: None,
    print_conv: Some(composite_printconv_canon_digitalzoom),
    value_conv_expr: None,
...
pub static COMPOSITE_CANON_DRIVEMODE: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_canon_drivemode),
    print_conv: None,
...
pub static COMPOSITE_CANON_ISO: CompositeTagDef = CompositeTagDef {
    ...
    inhibit: &[],
    value_conv: Some(composite_valueconv_canon_iso),
    print_conv: Some(composite_printconv_canon_iso),
    value_conv_expr: Some(
...
pub static COMPOSITE_CANON_LENS: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_canon_lens),
    print_conv: None, // PPI generation failed
    value_conv_expr: Some("$val[0]"),
...
pub static COMPOSITE_CANON_LENS35EFL: CompositeTagDef = CompositeTagDef {
    ...
    inhibit: &[],
    value_conv: Some(composite_valueconv_canon_lens35efl),
    print_conv: None, // PPI generation failed
...
pub static COMPOSITE_CANON_REDEYEREDUCTION: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_canon_redeyereduction),
    print_conv: None,
...
pub static COMPOSITE_CANON_SHOOTINGMODE: CompositeTagDef = CompositeTagDef {
    ...
    desire: &["BulbDuration"],
    inhibit: &[],
    value_conv: Some(composite_valueconv_canon_shootingmode),
    print_conv: Some(composite_printconv_canon_shootingmode),
    value_conv_expr: Some(
        "$val[0] ? (($val[0] eq \"4\" and $val[2]) ? 7 : $val[0]) : $val[1] + 10",
    ),
...
pub static COMPOSITE_KODAK_DATECREATED: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_kodak_datecreated),
    print_conv: None,
    value_conv_expr: Some("\"$val[0]:$val[1]\""),
    print_conv_expr: None,
    description: None,
...
pub static COMPOSITE_NIKON_AUTOFOCUS: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_nikon_autofocus),
    print_conv: None,
...
pub static COMPOSITE_NIKON_CONTRASTDETECTAF: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_nikon_contrastdetectaf),
    print_conv: None,
...
pub static COMPOSITE_NIKON_LENSSPEC: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_nikon_lensspec),
    print_conv: Some(composite_printconv_nikon_lensspec),
    value_conv_expr: Some("\"$val[0] $val[1]\""),
    print_conv_expr: Some("\"$prt[0] $prt[1]\""),
    description: None,
    groups: &[(0, "Composite"), (1, "Composite"), (2, "Camera")],
...
pub static COMPOSITE_NIKON_PHASEDETECTAF: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_nikon_phasedetectaf),
    print_conv: None,
...
pub static COMPOSITE_OLYMPUS_LENSTYPE: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_olympus_lenstype),
    print_conv: None,
    value_conv_expr: Some("\"$val[0] $val[1]\""),
    print_conv_expr: None,
    description: None,
...
pub static COMPOSITE_PANASONIC_ADVANCEDSCENEMODE: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_panasonic_advancedscenemode),
    print_conv: None,
...
pub static COMPOSITE_SONY_FOCUSDISTANCE: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_sony_focusdistance),
    print_conv: Some(composite_printconv_sony_focusdistance),
...
pub static COMPOSITE_SONY_FOCUSDISTANCE2: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_sony_focusdistance2),
    print_conv: Some(composite_printconv_sony_focusdistance2),
...
pub static COMPOSITE_SONY_GPSDATETIME: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_sony_gpsdatetime),
    print_conv: None, // PPI generation failed
    value_conv_expr: Some("\"$val[0] $val[1]Z\""),
    print_conv_expr: Some("$self->ConvertDateTime($val)"),
    description: Some("GPS Date/Time"),
...
pub static COMPOSITE_SONY_GPSLATITUDE: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_sony_gpslatitude),
    print_conv: None, // PPI generation failed
    value_conv_expr: Some(r"$val[1] =~ /^S/i ? -$val[0] : $val[0]"),
    print_conv_expr: Some("Image::ExifTool::GPS::ToDMS($self, $val, 1, \"N\")"),
    description: None,
...
pub static COMPOSITE_SONY_GPSLONGITUDE: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_sony_gpslongitude),
    print_conv: None, // PPI generation failed
    value_conv_expr: Some(r"$val[1] =~ /^W/i ? -$val[0] : $val[0]"),
    print_conv_expr: Some("Image::ExifTool::GPS::ToDMS($self, $val, 1, \"E\")"),
    description: None,
...
pub static COMPOSITE_PANASONICRAW_IMAGEHEIGHT: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_panasonicraw_imageheight),
    print_conv: None,
...
pub static COMPOSITE_PANASONICRAW_IMAGEWIDTH: CompositeTagDef = CompositeTagDef {
    ...
    desire: &[],
    inhibit: &[],
    value_conv: Some(composite_valueconv_panasonicraw_imagewidth),
    print_conv: None,
    value_conv_expr: Some("$val[1] - $val[0]"),
    print_conv_expr: None,
    description: None,
...
pub static COMPOSITE_QUICKTIME_GPSALTITUDE: CompositeTagDef = CompositeTagDef {
    ...
    inhibit: &[],
    value_conv: None, // PPI generation failed
    print_conv: Some(composite_printconv_quicktime_gpsaltitude),
...
pub static COMPOSITE_XMP_LENSID: CompositeTagDef = CompositeTagDef {
    ...
    inhibit: &["Composite:LensID"],
    value_conv: Some(composite_valueconv_xmp_lensid),
    print_conv: None, // PPI generation failed
    value_conv_expr: Some("$val"),
