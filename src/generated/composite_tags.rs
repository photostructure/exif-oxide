...
pub static COMPOSITE_TAGS: &[CompositeTagDef] = &[
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[],
        desire: &[(0, "WB_RGGBLevels"), (3, "WB_GRBGLevels"), (1, "WB_RGBGLevels"), (9, "WBBlueLevel"), (4, "WB_GRGBLevels"), (10, "WBGreenLevel"), (7, "WB_GRBLevels"), (5, "WB_GBRGLevels"), (2, "WB_RBGGLevels"), (8, "WB_RBLevels"), (6, "WB_RGBLevels"), ],
    ...
    CompositeTagDef {
        ...
        desire: &[(4, "SubjectDistance"), (5, "ObjectDistance"), (3, "FocusDistance"), (6, "ApproximateFocusDistance"), (7, "FocusDistanceLower"), (8, "FocusDistanceUpper"), ],
    ...
    CompositeTagDef {
        ...
        require: &[],
        desire: &[(2, "TimeCreated"), (0, "DateTimeCreated"), (1, "DateCreated"), ],
    ...
    CompositeTagDef {
        ...
        desire: &[(3, "ExifImageHeight"), (2, "ExifImageWidth"), (4, "RawImageCroppedSize"), ],
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[(0, "LensType"), ],
        desire: &[(2, "MaxAperture"), (6, "LensModel"), (8, "LensSpec"), (5, "MaxFocalLength"), (3, "MaxApertureValue"), (9, "LensType2"), (12, "RFLensType"), (7, "LensFocalRange"), (10, "LensType3"), (11, "LensFocalLength"), (4, "MinFocalLength"), (1, "FocalLength"), ],
        value_conv: Some("$val"),
    ...
    CompositeTagDef {
        ...
        table: "Main",
        description: None,
        require: &[(1, "PreviewImageLength"), (0, "PreviewImageStart"), ],
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[],
        desire: &[(2, "WB_RBGGLevels"), (10, "WBGreenLevel"), (9, "WBRedLevel"), (6, "WB_RGBLevels"), (7, "WB_GRBLevels"), (1, "WB_RGBGLevels"), (5, "WB_GBRGLevels"), (3, "WB_GRBGLevels"), (8, "WB_RBLevels"), (0, "WB_RGGBLevels"), (4, "WB_GRGBLevels"), ],
    ...
    CompositeTagDef {
        ...
        require: &[],
        desire: &[(9, "FocalPlaneYResolution"), (13, "CanonImageHeight"), (8, "FocalPlaneXResolution"), (7, "FocalPlaneResolutionUnit"), (4, "SensorSize"), (11, "ExifImageHeight"), (1, "FocalLengthIn35mmFormat"), (0, "FocalLength"), (2, "Composite:DigitalZoom"), (10, "ExifImageWidth"), (3, "FocalPlaneDiagonal"), (12, "CanonImageWidth"), (14, "ImageWidth"), (15, "ImageHeight"), (5, "FocalPlaneXSize"), (6, "FocalPlaneYSize"), ],
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[],
        desire: &[(1, "ShutterSpeedValue"), (0, "ExposureTime"), (2, "BulbDuration"), ],
    ...
    CompositeTagDef {
        ...
        value_conv: None,
        print_conv_ref: None,
        groups: &[(1, "IFD1"), (0, "EXIF"), (2, "Preview"), ],
        writable: true,
        avoid: false,
        priority: 0,
    ...
    CompositeTagDef {
        ...
        table: "Main",
        description: None,
        require: &[(7, "SamplesPerPixel"), (5, "PhotometricInterpretation"), (8, "RowsPerStrip"), (1, "Compression"), (4, "BitsPerSample"), (6, "StripOffsets"), (9, "StripByteCounts"), (0, "SubfileType"), (2, "ImageWidth"), (3, "ImageHeight"), ],
        desire: &[(10, "PlanarConfiguration"), (11, "Orientation"), ],
        value_conv: None,
        print_conv_ref: None,
        groups: &[(1, "Composite"), (2, "Preview"), (0, "Composite"), ],
        writable: false,
        avoid: false,
        priority: 0,
        notes: None,
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[],
        desire: &[(0, "GPS:GPSAltitude"), (3, "XMP:GPSAltitudeRef"), (2, "XMP:GPSAltitude"), (1, "GPS:GPSAltitudeRef"), ],
    ...
    CompositeTagDef {
        ...
        groups: &[(0, "Composite"), (2, "Time"), (1, "Composite"), ],
        writable: false,
        avoid: false,
        priority: 0,
        notes: None,
    ...
    CompositeTagDef {
        ...
        groups: &[(1, "Composite"), (2, "Location"), (0, "Composite"), ],
        writable: false,
        avoid: false,
        priority: 0,
        notes: None,
    ...
    CompositeTagDef {
        ...
        table: "Main",
        description: None,
        require: &[(1, "GPS:GPSLongitudeRef"), (0, "GPS:GPSLongitude"), ],
        desire: &[],
        value_conv: Some("$val[1] =~ /^W/i ? -$val[0] : $val[0]"),
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[],
        desire: &[(1, "ApertureValue"), (0, "FNumber"), ],
        value_conv: Some("$val[0] || $val[1]"),
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[],
        desire: &[(9, "WBBlueLevel"), (0, "WB_RGGBLevels"), (2, "WB_RBGGLevels"), (4, "WB_GRGBLevels"), (3, "WB_GRBGLevels"), (5, "WB_GBRGLevels"), (1, "WB_RGBGLevels"), (7, "WB_GRBLevels"), (6, "WB_RGBLevels"), (10, "WBGreenLevel"), (8, "WB_RBLevels"), ],
        value_conv: Some("Image::ExifTool::Exif::RedBlueBalance(1,@val)"),
    ...
    CompositeTagDef {
        ...
        description: Some("Date/Time Original"),
        require: &[],
        desire: &[(1, "DateCreated"), (0, "DateTimeCreated"), (2, "TimeCreated"), ],
        value_conv: Some("\n            return $val[0] if $val[0] and $val[0]=~/ /;\n            return \"$val[1] $val[2]\";\n        "),
    ...
    CompositeTagDef {
        ...
        table: "EXIF",
        description: None,
        require: &[(1, "Aperture"), (0, "FocalLength"), (2, "CircleOfConfusion"), ],
        desire: &[],
        value_conv: Some("\n            ToFloat(@val);\n            return 'inf' unless $val[1] and $val[2];\n            return $val[0] * $val[0] / ($val[1] * $val[2] * 1000);\n        "),
        print_conv_ref: Some("composite_hyperfocaldistance_print_conv"),
        groups: &[(1, "Composite"), (0, "Composite"), (2, "Camera"), ],
        writable: false,
        avoid: false,
        priority: 0,
        notes: Some("this value may be incorrect if the image has been resized"),
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[(0, "ImageWidth"), (1, "ImageHeight"), ],
        desire: &[(4, "RawImageCroppedSize"), (3, "ExifImageHeight"), (2, "ExifImageWidth"), ],
        value_conv: Some("\n            return $val[4] if $val[4];\n            return \"$val[2] $val[3]\" if $val[2] and $val[3] and\n                    $$self{TIFF_TYPE} =~ /^(CR2|Canon 1D RAW|IIQ|EIP)$/;\n            return \"$val[0] $val[1]\" if IsFloat($val[0]) and IsFloat($val[1]);\n            return undef;\n        "),
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[(0, "LensType"), ],
        desire: &[(4, "MinFocalLength"), (11, "LensFocalLength"), (3, "MaxApertureValue"), (10, "LensType3"), (9, "LensType2"), (6, "LensModel"), (8, "LensSpec"), (5, "MaxFocalLength"), (7, "LensFocalRange"), (2, "MaxAperture"), (12, "RFLensType"), (1, "FocalLength"), ],
        value_conv: Some("$val"),
    ...
    CompositeTagDef {
        ...
        table: "EXIF",
        description: None,
        require: &[(2, "ISO"), (0, "Aperture"), (1, "ShutterSpeed"), ],
        desire: &[],
        value_conv: Some("Image::ExifTool::Exif::CalculateLV($val[0],$val[1],$prt[2])"),
    ...
    CompositeTagDef {
        ...
        desire: &[(3, "PreviewImageStart (1)"), (2, "PreviewImageValid"), (4, "PreviewImageLength (1)"), ],
        value_conv: None,
        print_conv_ref: None,
        groups: &[(1, "SubIFD"), (2, "Preview"), (0, "EXIF"), ],
        writable: true,
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[],
        desire: &[(3, "WB_GRBGLevels"), (5, "WB_GBRGLevels"), (6, "WB_RGBLevels"), (8, "WB_RBLevels"), (1, "WB_RGBGLevels"), (0, "WB_RGGBLevels"), (4, "WB_GRGBLevels"), (7, "WB_GRBLevels"), (9, "WBRedLevel"), (10, "WBGreenLevel"), (2, "WB_RBGGLevels"), ],
        value_conv: Some("Image::ExifTool::Exif::RedBlueBalance(0,@val)"),
    ...
    CompositeTagDef {
        ...
        description: Some("Scale Factor To 35 mm Equivalent"),
        require: &[],
        desire: &[(1, "FocalLengthIn35mmFormat"), (0, "FocalLength"), (10, "ExifImageWidth"), (9, "FocalPlaneYResolution"), (11, "ExifImageHeight"), (15, "ImageHeight"), (14, "ImageWidth"), (13, "CanonImageHeight"), (5, "FocalPlaneXSize"), (4, "SensorSize"), (7, "FocalPlaneResolutionUnit"), (12, "CanonImageWidth"), (6, "FocalPlaneYSize"), (8, "FocalPlaneXResolution"), (2, "Composite:DigitalZoom"), (3, "FocalPlaneDiagonal"), ],
        value_conv: Some("Image::ExifTool::Exif::CalcScaleFactor35efl($self, @val)"),
    ...
    CompositeTagDef {
        ...
        description: None,
        require: &[],
        desire: &[(2, "BulbDuration"), (0, "ExposureTime"), (1, "ShutterSpeedValue"), ],
        value_conv: Some("($val[2] and $val[2]>0) ? $val[2] : (defined($val[0]) ? $val[0] : $val[1])"),
    ...
    CompositeTagDef {
        ...
        table: "EXIF",
        description: None,
        require: &[(4, "BitsPerSample"), (0, "SubfileType"), (3, "ImageHeight"), (7, "SamplesPerPixel"), (8, "RowsPerStrip"), (6, "StripOffsets"), (2, "ImageWidth"), (9, "StripByteCounts"), (1, "Compression"), (5, "PhotometricInterpretation"), ],
        desire: &[(11, "Orientation"), (10, "PlanarConfiguration"), ],
        value_conv: None,
        print_conv_ref: None,
