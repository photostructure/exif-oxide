...
pub static COMPOSITE_TAGS: &[CompositeTagDef] = &[
    ...
    CompositeTagDef {
        ...
        desire: &[],
        print_conv_ref: Some("audiobitrate_print_conv"),
        value_conv_ref: Some("audiobitrate_value_conv"),
        description: None,
        writable: false,
    },
    CompositeTagDef {
        ...
        desire: &[],
        print_conv_ref: Some("autofocus_print_conv"),
        value_conv_ref: Some("autofocus_value_conv"),
        description: None,
        writable: false,
    },
    CompositeTagDef {
        ...
        desire: &[],
        print_conv_ref: Some("avgbitrate_print_conv"),
        value_conv_ref: None,
        description: None,
        writable: false,
    },
    ...
    CompositeTagDef {
        ...
        require: &["CDDB1Info"],
        desire: &[],
        print_conv_ref: Some("cddbdiscplaytime_print_conv"),
        value_conv_ref: Some("cddbdiscplaytime_value_conv"),
        description: None,
        writable: false,
    },
    CompositeTagDef {
        ...
        desire: &[],
        print_conv_ref: None,
        value_conv_ref: Some("cddbdisctracks_value_conv"),
        description: None,
        writable: false,
    },
    CompositeTagDef {
    ...
    CompositeTagDef {
        ...
        desire: &[],
        print_conv_ref: Some("conditionalfec_print_conv"),
        value_conv_ref: Some("conditionalfec_value_conv"),
    ...
    CompositeTagDef {
        ...
        desire: &[],
        print_conv_ref: Some("contrastdetectaf_print_conv"),
        value_conv_ref: Some("contrastdetectaf_value_conv"),
        description: None,
        writable: false,
    },
    CompositeTagDef {
    ...
    CompositeTagDef {
        ...
        desire: &[],
        print_conv_ref: Some("digitalzoom_print_conv"),
        value_conv_ref: None,
        description: None,
        writable: false,
    },
    CompositeTagDef {
        ...
        desire: &[],
        print_conv_ref: Some("drivemode_print_conv"),
        value_conv_ref: Some("drivemode_value_conv"),
        description: None,
        writable: false,
    },
    CompositeTagDef {
        ...
        print_conv_ref: Some("duration_print_conv"),
        value_conv_ref: Some("duration_value_conv"),
        description: None,
        writable: false,
    },
    CompositeTagDef {
    ...
    CompositeTagDef {
        ...
        print_conv_ref: Some("duration2_print_conv"),
        value_conv_ref: None,
        description: None,
        writable: false,
    },
    CompositeTagDef {
        ...
        desire: &[],
        print_conv_ref: Some("extenderstatus_print_conv"),
        value_conv_ref: Some("extenderstatus_value_conv"),
        description: None,
        writable: false,
    },
    CompositeTagDef {
        ...
        desire: &[],
        print_conv_ref: Some("filenumber_print_conv"),
        value_conv_ref: Some("filenumber_value_conv"),
        description: None,
        writable: true,
    },
    CompositeTagDef {
        ...
        require: &["FlashBits"],
        desire: &[],
        print_conv_ref: Some("flashtype_print_conv"),
        value_conv_ref: Some("flashtype_value_conv"),
        description: None,
        writable: false,
    },
    CompositeTagDef {
    ...
    CompositeTagDef {
        ...
        desire: &[],
        print_conv_ref: Some("gpsaltitude2_print_conv"),
        value_conv_ref: Some("gpsaltitude2_value_conv"),
        description: None,
        writable: false,
    },
    CompositeTagDef {
        ...
        value_conv_ref: Some("gpsaltituderef_value_conv"),
        description: None,
        writable: false,
    },
    CompositeTagDef {
        ...
        require: &["QuickTime:LocationInformation"],
        desire: &[],
        print_conv_ref: Some("gpsaltituderef2_print_conv"),
        value_conv_ref: Some("gpsaltituderef2_value_conv"),
        description: None,
        writable: false,
    },
    CompositeTagDef {
    ...
    CompositeTagDef {
        ...
        require: &["QuickTime:LocationInformation"],
        desire: &[],
        print_conv_ref: Some("gpslatitude2_print_conv"),
        value_conv_ref: Some("gpslatitude2_value_conv"),
        description: None,
        writable: false,
    },
    CompositeTagDef {
    ...
    CompositeTagDef {
        ...
        require: &["QuickTime:LocationInformation"],
        desire: &[],
        print_conv_ref: Some("gpslongitude2_print_conv"),
        value_conv_ref: Some("gpslongitude2_value_conv"),
        description: None,
        writable: false,
    },
    CompositeTagDef {
    ...
    CompositeTagDef {
        ...
        desire: &[],
        print_conv_ref: Some("lens_print_conv"),
    ...
    CompositeTagDef {
        ...
        desire: &["ScaleFactor35efl"],
        print_conv_ref: Some("lens35efl_print_conv"),
        value_conv_ref: Some("lens35efl_value_conv"),
    ...
    CompositeTagDef {
        ...
        desire: &[],
        print_conv_ref: Some("lensspec_print_conv"),
        value_conv_ref: Some("lensspec_value_conv"),
        description: None,
        writable: false,
    },
    CompositeTagDef {
        ...
        desire: &[],
        print_conv_ref: Some("lenstype_print_conv"),
        value_conv_ref: Some("lenstype_value_conv"),
        description: None,
        writable: false,
    },
    CompositeTagDef {
    ...
    CompositeTagDef {
        ...
        desire: &[],
        print_conv_ref: Some("phasedetectaf_print_conv"),
        value_conv_ref: Some("phasedetectaf_value_conv"),
        description: None,
        writable: false,
    },
    CompositeTagDef {
    ...
    CompositeTagDef {
        ...
        desire: &[],
        print_conv_ref: Some("redeyereduction_print_conv"),
        value_conv_ref: Some("redeyereduction_value_conv"),
        description: None,
        writable: false,
    },
    CompositeTagDef {
        ...
        desire: &[],
        print_conv_ref: None,
        value_conv_ref: Some("rotation_value_conv"),
        description: None,
        writable: true,
    },
    CompositeTagDef {
    ...
    CompositeTagDef {
        ...
        desire: &["BulbDuration"],
        print_conv_ref: Some("shootingmode_print_conv"),
        value_conv_ref: Some("shootingmode_value_conv"),
        description: None,
        writable: false,
    },
    CompositeTagDef {
        ...
        print_conv_ref: Some("shuttercurtainhack_print_conv"),
        value_conv_ref: Some("shuttercurtainhack_value_conv"),
    ...
    CompositeTagDef {
        ...
        print_conv_ref: None,
        value_conv_ref: Some("wb_rggblevels_value_conv"),
        description: None,
        writable: false,
    },
    CompositeTagDef {
