//! Generated tag table definitions from QuickTime::HintSampleDesc
//!
...
/// Tag definitions for QuickTime::HintSampleDesc table
pub static QUICK_TIME_HINTSAMPLEDESC_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            4,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = QUICK_TIME_HINTSAMPLEDESC_TAGS.get(&tag_id_u16) {
