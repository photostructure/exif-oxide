//! Generated lookup table for ftypLookup from ExifTool's QuickTime module
//!
...
/// Raw data for ftypLookup lookup table
static FTYP_LOOKUP_DATA: &[(&str, &'static str)] = &[
    (
        "3g2a",
...
/// ftypLookup lookup table
pub static FTYP_LOOKUP: LazyLock<HashMap<&str, &'static str>> =
    LazyLock::new(|| FTYP_LOOKUP_DATA.iter().copied().collect());

/// Look up ftypLookup value by key
pub fn lookup_ftyp_lookup(key: &str) -> Option<&'static str> {
    FTYP_LOOKUP.get(&key).copied()
}
