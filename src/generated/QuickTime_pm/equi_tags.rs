//! Generated tag table definitions from QuickTime::equi
//!
    ...
    HashMap::from([
        (
            ...
            TagInfo {
                ...
                format: "unknown",
                print_conv: None,
                value_conv: Some(ValueConv::Expression("$val / 4294967296".to_string())),
            },
        ),
        (
            2,
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = QUICK_TIME_EQUI_TAGS.get(&tag_id_u16) {
