//! Generated tag table definitions from QuickTime::FileProf
//!
...
/// Tag definitions for QuickTime::FileProf table
pub static QUICK_TIME_FILEPROF_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            0,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = QUICK_TIME_FILEPROF_TAGS.get(&tag_id_u16) {
