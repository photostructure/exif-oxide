//! Generated tag table definitions from QuickTime::TrackRef
//!
...
pub static QUICK_TIME_TRACKREF_TAGS: LazyLock<HashMap<u16, TagInfo>> =
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = QUICK_TIME_TRACKREF_TAGS.get(&tag_id_u16) {
