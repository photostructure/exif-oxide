//! Generated tag table definitions from QuickTime::MetaData
//!
    ...
    HashMap::from([
        ...
        (
            ...
            TagInfo {
                name: "TimeZone",
                format: "unknown",
                print_conv: Some(PrintConv::Expression("TimeZoneString($val)".to_string())),
                value_conv: None,
            },
        ),
        (
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = QUICK_TIME_METADATA_TAGS.get(&tag_id_u16) {
