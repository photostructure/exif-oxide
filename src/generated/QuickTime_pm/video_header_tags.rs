//! Generated tag table definitions from QuickTime::VideoHeader
//!
...
/// Tag definitions for QuickTime::VideoHeader table
pub static QUICK_TIME_VIDEOHEADER_TAGS: LazyLock<HashMap<u16, TagInfo>> = LazyLock::new(|| {
    HashMap::from([
        (
            2,
            TagInfo {
...
pub fn apply_value_conv(
    ...
    if let Some(tag_def) = QUICK_TIME_VIDEOHEADER_TAGS.get(&tag_id_u16) {
