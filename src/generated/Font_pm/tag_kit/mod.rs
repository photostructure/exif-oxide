//! Modular tag kits with embedded PrintConv for Font_pm
//!
//! This file is automatically generated by codegen.
//! DO NOT EDIT MANUALLY - changes will be overwritten.
//!
//! Generated from: Font.pm table: AFM
//!
...
/// All tag kits for Font_pm
pub static FONT_PM_TAG_KITS: LazyLock<HashMap<u32, TagKitDef>> = LazyLock::new(|| {
...
fn process_font_name(data: &[u8], _byte_order: ByteOrder) -> Result<Vec<(String, TagValue)>> {
    // TODO: Implement when this table is extracted
    tracing::debug!("Stub function called for {}", data.len());
    Ok(vec![])
}

fn process_font_psinfo(data: &[u8], _byte_order: ByteOrder) -> Result<Vec<(String, TagValue)>> {
    // TODO: Implement when this table is extracted
    tracing::debug!("Stub function called for {}", data.len());
    Ok(vec![])
}
...
pub fn apply_print_conv(
    ...
    if let Some(tag_kit) = FONT_PM_TAG_KITS.get(&tag_id) {
