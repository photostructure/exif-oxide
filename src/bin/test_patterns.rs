...
fn main() {
    ...
    let mut file =
        File::open("/mnt/2tb/home/mrm/src/exif-oxide/third-party/exiftool/t/images/PNG.png")
            .unwrap();
    ...
    // Test other patterns
    println!(
        "JPEG pattern matches: {}",
        matches_magic_number("JPEG", &buffer)
    );
    println!(
        "GIF pattern matches: {}",
        matches_magic_number("GIF", &buffer)
    );
