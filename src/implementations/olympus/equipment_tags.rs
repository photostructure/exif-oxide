...
//!
//! This should ideally be generated by codegen, but the current codegen system
//! only supports one tag_table_structure per module. Once multi-table support
//! is added, this file can be replaced with generated code.
