...
fn main() {
    ...
    let rust_code = generate_rust_code(&exif_tags, &canon_tags);
...
fn generate_rust_code(exif_tags: &[TagDef], canon_tags: &[TagDef]) -> String {
    let mut code = String::new();

    code.push_str("// Generated from ExifTool's Exif.pm and Canon.pm\n");
    code.push_str("// DO NOT EDIT - This file is auto-generated by build.rs\n\n");
